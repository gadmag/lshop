<template>
    <div :id="name + '_component'" class="files_component">
        <div :class="{'has-advanced-upload': isAdvanced}" ref="drop" class="box file_upload">
            <div class="box_input">
                <svg v-if="attachments.length == 0" class="box__icon" xmlns="http://www.w3.org/2000/svg" width="50" height="43" viewBox="0 0 50 43">
