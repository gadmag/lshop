...
<div class="row">
    <div class="col-md-8 page-default">
        ...
        {{--<div class="form-group">--}}
            {{--{!! Form::label('videoAttr[url]', 'Url видео:') !!}&nbsp;--}}
            {{--{!! Form::text('videoAttr[url]', null, ['class' => 'form-control' ]) !!}--}}
            {{--<p class="help-block">Ссылка с сайта youtube</p>--}}
        {{--</div> --}}
        <div class="form-group">
            {!! Form::label('body', 'Код для видео') !!}&nbsp;
            {!! Form::textarea('body', null, ['class' => 'form-control' ]) !!}
            <p class="help-block">Код с сайта youtube</p>
        </div>
