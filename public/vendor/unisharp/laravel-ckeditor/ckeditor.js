...
(function () {
    window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function () {
                ...
                define: function (b, e) {
                    ...
                    function h(a, g, d, h) {
                        a = {
                            ...
                            data: g, listenerData: l, stop: d, cancel: h, removeListener: k
                        };
                    ...
                    if (0 > g.getListenerIndex(e)) {
                        ...
                        h.fn = e;
                        h.priority = d;
                        for (var v = g.length - 1; 0 <= v; v--) if (g[v].priority <= d) return g.splice(v + 1, 0, h), {removeListener: k};
                        g.unshift(h)
                    }
                    ...
                    return function (d, h, k) {
                        ...
                        if (g) {
                            ...
                            if (v.length) for (var v = v.slice(0), t, w = 0; w < v.length; w++) {
                                ...
                                } else t = v[w].call(this, k, h, b, l);
                                !1 === t ? m = 1 : "undefined" != typeof t && (h = t);
                                if (a || m) break
                            }
                        }
                        h =
                            m ? !1 : "undefined" == typeof h ? !0 : h;
                        a = d;
                        m = n;
                        return h
                    }
        ...
        var a = navigator.userAgent.toLowerCase(), f = a.match(/edge[ \/](\d+.?\d*)/), b = -1 < a.indexOf("trident/"),
            b = !(!f && !b), b = {
                ie: b,
                edge: !!f,
                webkit: !b &&
        ...
        (function () {
            CKEDITOR.domReady(function () {
                ...
                a && (CKEDITOR.status =
                    "basic_ready", a && a._load ? a() : f && setTimeout(function () {
        ...
        if (window.console && window.console.log) {
            var f = console[a.data.type] ? a.data.type : "log", b = a.data.errorCode;
        ...
        var a = [], f = CKEDITOR.env.gecko ? "-moz-" :
            CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, m = /"/g,
            l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            d = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, h = function (a, g) {
        ...
        CKEDITOR.tools = {
            ...
            getIndex: function (a, g) {
                for (var d =
                    0; d < a.length; ++d) if (g(a[d])) return d;
                return -1
            },
            clone: function (a) {
                var g;
            ...
            buildStyleHtml: function (a) {
                a = [].concat(a);
                for (var g, d = [], b = 0; b < a.length; b++) if (g = a[b]) /@import|[{}]/.test(g) ? d.push("\x3cstyle\x3e" +
                    g + "\x3c/style\x3e") : d.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + g + '"\x3e');
                return d.join("")
            },
            ...
            transformPlainTextToHtml: function (a, g) {
                ...
                if (!d) {
                    var c = /\n{2}/g;
                    if (c.test(b)) var e = "\x3c" + h + "\x3e", f = "\x3c/" + h + "\x3e",
            ...
            createClass: function (a) {
                var g = a.$, d = a.base, b = a.privates || a._, h = a.proto;
                a = a.statics;
                !g && (g = function () {
                    d && this.base.apply(this, arguments)
                });
                if (b) var c = g, g = function () {
            ...
            normalizeCssText: function (a, g) {
                var d = [], b, h = CKEDITOR.tools.parseCssText(a, !0, g);
                for (b in h) d.push(b + ":" + h[b]);
                d.sort();
                return d.length ? d.join(";") + ";" : ""
            },
            convertRgbToHex: function (a) {
                return a.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi, function (a, d, b, k) {
                    a = [d, b, k];
            ...
            parseCssText: function (a, g, d) {
                ...
                if (!a || ";" == a) return b;
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, d, k) {
                    g && (d = d.toLowerCase(), "font-family" == d && (k = k.replace(/\s*,\s*/g,
            ...
            enableHtml5Elements: function (a, g) {
                for (var d = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "),
                         b = d.length, h; b--;) h = a.createElement(d[b]), g && a.appendChild(h)
            },
            ...
            getCsrfToken: function () {
                ...
                if (!a || 40 != a.length) {
                    ...
                    for (d = 0; d < a.length; d++) var b = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[d] % 36), g = g + (.5 < Math.random() ?
                        b.toUpperCase() : b);
                    a = g;
            ...
            style: {
                parse: {
                    ...
                    margin: function (a) {
                        ...
                        var d = {}, b = a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset)/g) || ["0px"];
                        switch (b.length) {
                            case 1:
                                g([0, 0, 0, 0]);
                                break;
                    ...
                    _findColor: function (a) {
                        ...
                        return g = g.concat(d.filter(a.split(/\s+/), function (a) {
                            return a.match(/^\#[a-f0-9]{3}(?:[a-f0-9]{3})?$/gi) ?
                                !0 : a.toLowerCase() in CKEDITOR.tools.style.parse._colors
                        }))
                    }
                }
            },
        ...
        var a = CKEDITOR.tools.extend, f = function (a, g) {
                ...
                table: 1,
                ul: 1
            }, m = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, l = {}, d = {"#": 1},
        ...
        a(b, {
            ...
            video: 1,
            wbr: 1
        }, d, {acronym: 1, applet: 1, basefont: 1, big: 1, font: 1, isindex: 1, strike: 1, style: 1, tt: 1});
        a(c, e, b, h);
        f = {
            a: f(b, {
                a: 1,
        ...
        a(f, {
            $block: a({audio: 1, dd: 1, dt: 1, figcaption: 1, li: 1, video: 1}, e, h),
            $blockLimit: {
                article: 1,
                aside: 1,
                audio: 1,
    ...
    }, CKEDITOR.CTRL = 1114112, CKEDITOR.SHIFT = 2228224, CKEDITOR.ALT = 4456448, CKEDITOR.EVENT_PHASE_CAPTURING = 1, CKEDITOR.EVENT_PHASE_AT_TARGET =
        2, CKEDITOR.EVENT_PHASE_BUBBLING = 3, CKEDITOR.dom.domObject = function (a) {
        a && (this.$ = a)
        ...
        return {
            getPrivate: function () {
                ...
                b[f] || (b = b[f] = a(this, f), this.$.addEventListener ?
                    this.$.addEventListener(f, b, !!CKEDITOR.event.useCapture) : this.$.attachEvent && this.$.attachEvent("on" + f, b));
                ...
                var a =
                    this.getCustomData("_cke_nativeListeners"), b;
                for (b in a) {
                    var c = a[b];
        ...
        a.removeCustomData = function (a) {
            var c = this.$["data-cke-expando"], c = c && f[c], e, m;
        ...
        return a ?
            new CKEDITOR.dom[a.nodeType == CKEDITOR.NODE_DOCUMENT ? "document" : a.nodeType == CKEDITOR.NODE_ELEMENT ? "element" : a.nodeType == CKEDITOR.NODE_TEXT ? "text" : a.nodeType == CKEDITOR.NODE_COMMENT ? "comment" : a.nodeType == CKEDITOR.NODE_DOCUMENT_FRAGMENT ? "documentFragment" : "domObject"](a) : this
    }, CKEDITOR.dom.node.prototype = new CKEDITOR.dom.domObject, CKEDITOR.NODE_ELEMENT = 1, CKEDITOR.NODE_DOCUMENT = 9, CKEDITOR.NODE_TEXT = 3, CKEDITOR.NODE_COMMENT = 8, CKEDITOR.NODE_DOCUMENT_FRAGMENT = 11, CKEDITOR.POSITION_IDENTICAL = 0, CKEDITOR.POSITION_DISCONNECTED =
        1, CKEDITOR.POSITION_FOLLOWING = 2, CKEDITOR.POSITION_PRECEDING = 4, CKEDITOR.POSITION_IS_CONTAINED = 8, CKEDITOR.POSITION_CONTAINS = 16, CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getIndex: function (a) {
            ...
            for (; f;) {
                ...
                if (f.hasAttribute("contenteditable")) return "false" ==
        ...
        focus: function () {
            ...
            var a = this.$.document, f = "CSS1Compat" == a.compatMode;
            return {
        ...
        var c = f.getCustomData("list_marker_names"),
            e = f.getCustomData("list_marker_id"), m;
        ...
        function c(a) {
            for (var b =
                0, c = 0, g = l[a].length; c < g; c++) b += parseFloat(this.getComputedStyle(l[a][c]) || 0, 10) || 0;
            return b
        }

        var e = document.createElement("_").classList,
            e = "undefined" !== typeof e && null !== String(e.add).match(/\[Native code\]/gi), m = /[\n\t\r]/g;
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            type: CKEDITOR.NODE_ELEMENT, addClass: e ? function (a) {
                ...
                if (a || CKEDITOR.env.needsBrFiller) {
                    ...
                    a && a.is && a.is("br") || (a = this.getDocument().createElement("br"), CKEDITOR.env.gecko && a.setAttribute("type",
                        "_moz"), this.append(a))
                }
                ...
                c.setEndAfter(a);
                var g = c.extractContents(!1, b || !1), e;
            ...
            is: function () {
                ...
                function a(b, d, g) {
                    if (d && d.type == CKEDITOR.NODE_ELEMENT) {
                        for (var c =
                            []; d.data("cke-bookmark") || d.isEmptyInlineRemoveable();) if (c.push(d), d = g ? d.getNext() : d.getPrevious(), !d || d.type != CKEDITOR.NODE_ELEMENT) return;
                        if (b.isIdentical(d)) {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], e = 0; e < c.length; e++) if (g) for (var f =
                        0; f < g.length; f++) b.push([a, c[e], g[f]].join("-")); else b.push([a, c[e]].join("-"));
                ...
                var b = 0, c = 0, g = this.getDocument(), e = g.getBody(), f = "BackCompat" == g.$.compatMode;
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var m = this.$.getBoundingClientRect(), l = g.$.documentElement,
                        p = l.clientTop || e.$.clientTop || 0, q = l.clientLeft || e.$.clientLeft || 0, r = !0;
                ...
                } else for (p = this, q = null; p && "body" != p.getName() &&
                "html" != p.getName();) {
                    b += p.$.offsetLeft - p.$.scrollLeft;
                    c += p.$.offsetTop - p.$.scrollTop;
                    p.equals(this) || (b += p.$.clientLeft || 0, c += p.$.clientTop || 0);
                    for (; q && !q.equals(p);) b -= q.$.scrollLeft, c -= q.$.scrollTop, q = q.getParent();
                    q = p;
            ...
            getFrameDocument: function () {
                ...
                for (var g = 0; g < c.length; g++) {
                    var e = c[g], f = e.nodeName.toLowerCase(), m;
                ...
                var b = CKEDITOR.instances, c, g, e;
                a = a || void 0 === a;
        ...
        function a(a, b) {
            ...
            c = g.endContainer;
            var e = g.startOffset, k = g.endOffset, f, h = this.guard, n = this.type,
            ...
            this.current ? c = this.current[m](!1,
                n, f) : (a ? c.type == CKEDITOR.NODE_ELEMENT && (c = 0 < k ? c.getChild(k - 1) : !1 === f(c, !0) ? null : c.getPreviousSourceNode(!0, n, f)) : (c = d, c.type == CKEDITOR.NODE_ELEMENT && ((c = c.getChild(e)) || (c = !1 === f(d, !0) ? null : d.getNextSourceNode(!0, n, f)))), c && !1 === f(c) && (c = null));
            for (; c && !this._.end;) {
                this.current = c;
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, m = CKEDITOR.dom.walker.whitespaces(),
            l = CKEDITOR.dom.walker.bookmark(), d = CKEDITOR.dom.walker.temp(), h = function (a) {
        ...
        function f(a, b, c, d, e) {
            ...
            b = u || l;
            var y = a.startContainer, C = a.endContainer, x = a.startOffset, B = a.endOffset, D, F, G, I, H, K;
            if (u && C.type == CKEDITOR.NODE_TEXT && y.equals(C)) y = a.document.createText(y.substring(x, B)), c.append(y); else {
                ...
                y.type == CKEDITOR.NODE_TEXT ? u ? H = !0 : y.split(x) : 0 < y.getChildCount() ?
                    0 === x ? (y = y.getChild(x), D = !0) : y = y.getChild(x - 1) : G = D = !0;
                ...
                M = c;
                for (N = S; N <= T; N++) if (c = E[N], ca = c.getPrevious(), c.equals(J[N])) b && (M = M.getChild(0)); else {
                    N != T || c.equals(J[N]) && T < O ? b && (V = M.append(c.clone(0,
                        e))) : F ? k(c, M, !1, I) : K && M.append(a.document.createText(c.substring(0, B)));
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var f = this.getCommonAncestor(), h = this.root, m, l, u, y, C, x = !1, B, D;
                        B = this.startContainer;
                        var F = this.startOffset;
                        B.type == CKEDITOR.NODE_TEXT ? (F && (B = !CKEDITOR.tools.trim(B.substring(0, F)).length &&
                            B, x = !!B), B && ((y = B.getPrevious()) || (u = B.getParent()))) : (F && (y = B.getChild(F - 1) || B.getLast()), y || (u = B));
                        for (u = c(u); u || y;) {
                            if (u && !y) {
                                !C && u.equals(f) && (C = !0);
                            ...
                            for (; y;) if (B = !1, y.type == CKEDITOR.NODE_COMMENT) y = y.getPrevious(); else {
                                if (y.type == CKEDITOR.NODE_TEXT) D = y.getText(), d.test(D) && (y = null), B = /[\s\ufeff]$/.test(D); else if ((y.$.offsetWidth > (CKEDITOR.env.webkit ? 1 :
                                    0) || b && y.is("br")) && !y.data("cke-bookmark")) if (x && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                                    D = y.getText();
                                    if (d.test(D)) y = null; else for (var F = y.$.getElementsByTagName("*"), G = 0, I; I = F[G++];) if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                                        y = null;
                                        break
                                    }
                                    y && (B = !!D.length)
                        ...
                        B.type == CKEDITOR.NODE_TEXT ?
                            CKEDITOR.tools.trim(B.substring(F)).length ? x = !0 : (x = !B.getLength(), F == B.getLength() ? (y = B.getNext()) || (u = B.getParent()) : k(B, F) && (u = B.getParent())) : (y = B.getChild(F)) || (u = B);
                        for (; u || y;) {
                            if (u && !y) {
                                !C && u.equals(f) && (C = !0);
                                if (e ? u.isBlockBoundary() : !h.contains(u)) break;
                            ...
                            for (; y;) {
                                B = !1;
                                if (y.type == CKEDITOR.NODE_TEXT) D = y.getText(), k(y, 0) || (y = null), B = /^[\s\ufeff]/.test(D); else if (y.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < y.$.offsetWidth ||
                                        b && y.is("br")) && !y.data("cke-bookmark")) if (x && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                                        D = y.getText();
                                        if (d.test(D)) y = null; else for (F = y.$.getElementsByTagName("*"), G = 0; I = F[G++];) if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                                            y = null;
                                            break
                                        }
                                        y && (B = !!D.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var H, K,
                            J = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                            E = null, S = function (a) {
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            u = this.clone();
                            u = new CKEDITOR.dom.walker(u);
                            var O = CKEDITOR.dom.walker.whitespaces(), T = CKEDITOR.dom.walker.bookmark();
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), e = this.startContainer, k = this.endContainer, f = this.startOffset,
                        h = this.endOffset, m = 1, l = 1;
                    e && e.type == CKEDITOR.NODE_TEXT && (f ?
                        f >= e.getLength() ? d.setStartAfter(e) : (d.setStartBefore(e), m = 0) : d.setStartBefore(e));
            ...
            setStart: function (b, c) {
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, k = d.block, f = null;
                if (!c.blockLimit.equals(d.blockLimit)) return null;
                "br" != a && (e || (e = this.fixBlock(!0, a), k = (new CKEDITOR.dom.elementPath(this.endContainer,
                    this.root)).block), k || (k = this.fixBlock(!1, a)));
                ...
                return {
                    previousBlock: e, nextBlock: k, wasStartOfBlock: c,
                    wasEndOfBlock: d, elementPath: f
                }
                ...
                return function (b) {
                    for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), e = d.block || d.blockLimit, k; e && !e.equals(d.root) && !e.getFirst(a(e));) k = e.getParent(), this[b ? "setEndAt" : "setStartAt"](e, CKEDITOR.POSITION_AFTER_END), e.remove(1), e = k;
                    this.moveToBookmark(c)
                }
            }(), startPath: function () {
                ...
                var c, d = 0, e, k, f = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
            ...
            moveToElementEditEnd: function (a) {
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], k, f, h, m;
                if (c && c.find) for (f = c.find(a), k = 0; k < f.count(); k++) if (c = f.getItem(k), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING ||
                    d.startNode.equals(c), m = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED, h && m && e.push(c);
                return e
            }
        }
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    f = p.startPath();
                    var q = p.endPath(), r = !p.collapsed && c(p, f.block), z = !p.collapsed && c(p, q.block, 1);
                    ...
                    p.collapsed || (f = new CKEDITOR.dom.walker(p.clone()),
                        ...
                        q.root), this._.lastNode = (q.block || q.blockLimit).getNextSourceNode(!0))), this._.lastNode && p.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = p.document.createText(""), this._.lastNode.insertAfter(f)), p = null);
                    this._.started = 1;
                    f = p
                }
                q = this._.nextNode;
                ...
                for (this._.nextNode = null; q;) {
                    var r = 0, z = q.hasAscendant("pre"), A = q.type != CKEDITOR.NODE_ELEMENT, u = 0;
                    if (A) q.type == CKEDITOR.NODE_TEXT && e.test(q.getText()) && (A = 0); else {
                        ...
                        if (CKEDITOR.dtd.$block[y] && "false" == q.getAttribute("contenteditable")) {
                            ...
                            b(this, a, g);
                            break
                        } else if (q.isBlockBoundary(this.forceBrBreak && !z && {br: 1})) {
                ...
                if (!g) {
                    ...
                    r = {div: 1, th: 1, td: 1};
                    g = g.block;
                    !g && q && !this.enforceRealBlocks && r[q.getName()] &&
        ...
        function a(a, b, c, d, e) {
            ...
            for (g in b) {
                f = b[g];
                f = "boolean" == typeof f ? {} : "function" == typeof f ? {match: f} : G(f);
                ...
                for (u in K) {
                    k[u] = l(k[u],
                        h) || null;
                    var m = k, p = J[u], y = l(k[J[u]], h), q = k[u], C = [], n = !0, E = void 0;
                    y ? n = !1 : y = {};
                    for (E in q) "!" == E.charAt(0) && (E = E.slice(1), C.push(E), y[E] = !0, n = !1);
                    for (; E = C.pop();) q[E] = q["!" + E], delete q["!" + E];
                    m[p] = (n ? !1 : y) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (u in J) {
                    ...
                    y = [];
                    q = void 0;
                    for (q in p) -1 < q.indexOf("*") ? y.push(new RegExp("^" +
                        q.replace(/\*/g, ".*") + "$")) : y.push(q);
                    p = y;
                    p.length && (k[h] = p, m = !1)
                }
                k.nothingRequired = m;
                k.noProperties = !(k.attributes || k.classes || k.styles);
                if (!0 === g.elements || null === g.elements) e[f ? "unshift" : "push"](g); else for (x in k = g.elements, delete g.elements, k) if (b[x]) b[x][f ? "unshift" : "push"](g); else b[x] = [g]
            }
        }

        function f(a, c, e, g) {
            if (!a.match || a.match(c)) if (g || d(a, c)) if (a.propertiesOnly || (e.valid = !0), e.allAttributes || (e.allAttributes = b(a.attributes, c.attributes, e.validAttributes)), e.allStyles || (e.allStyles = b(a.styles,
                c.styles, e.validStyles)), !e.allClasses) {
                a = a.classes;
                c = c.classes;
                g = e.validClasses;
                if (a) if (!0 === a) a = !0; else {
                    for (var f = 0, k = c.length, h; f < k; ++f) h = c[f], g[h] || (g[h] = a(h));
                    a = !1
                } else a = !1;
                e.allClasses = a
            }
        ...
        function g(a) {
            var b, c, d, e, g = {}, f = 1;
            for (a = I(a); b = a.match(E);) (c = b[2]) ? (d = n(c, "styles"), e = n(c, "attrs"), c = n(c, "classes")) : d = e = c = null, g["$" + f++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: e
        ...
        function t(a, b, d, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var h = 0, u = k.length, m; h < u; ++h) if (m = k[h](b)) {
                        k = m;
                        break a
                    }
                    k = void 0
            ...
            if (e.doFilter) {
                a:{
                    ...
                    if (a || k) {
                        ...
                        if (k) for (r =
                                        0, C = k.length; r < C; ++r) f(k[r], b, l, m);
                        a = l
                    } else a = null
                }
                ...
                var n = a.validStyles;
                k = a.validClasses;
                var h = b.attributes, E = b.styles, u = b.classes;
                m = b.classBackup;
                var x = b.styleBackup, J, z, w = [], l = [], t = /^data-cke-/;
                r = !1;
                delete h.style;
                delete h["class"];
                ...
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (J in E) a.allStyles ||
                    n[J] ? w.push(J + ":" + E[J]) : r = !0;
        ...
        function u(a, b, c) {
            ...
            if (F.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(z()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (F.$block[d] || "tr" == d) if ("br" == b) a.previous && !A(a.previous) && (b = z(), b.insertBefore(a)), a.next && !A(a.next) && (b = z(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, e;
                b:{
                    e = F[b];
                    for (var g = 0, k = d.length, f; g < k; ++g) if (f = d[g], f.type == CKEDITOR.NODE_ELEMENT &&
                    !e[f.name]) {
                        e = !1;
                        break b
                    }
                ...
                if (e) a.name = b, a.attributes = {}, c.push({check: "parent-down", el: a}); else {
                    e = a.parent;
                    for (var g = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, h, u, k = d.length; 0 < k;) f = d[--k], g && (f.type == CKEDITOR.NODE_TEXT || f.type == CKEDITOR.NODE_ELEMENT && F.$inline[f.name]) ? (h || (h = new CKEDITOR.htmlParser.element(b), h.insertAfter(a), c.push({
                        check: "parent-down",
                        el: h
                    })), h.add(f, 0)) : (h = null, u = F[e.name] || F.span, f.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.type != CKEDITOR.NODE_ELEMENT ||
                    u[f.name] || c.push({check: "el-up", el: f}));
                    a.remove()
                }
        ...
        function C(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, g, k, f, h;
        ...
        var F = CKEDITOR.dtd, G = CKEDITOR.tools.copy, I = CKEDITOR.tools.trim, H = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter = function (a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                !0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(H[a.enterMode] +
                    " " + H[a.shiftEnterMode], "default", 1), this.disallow(a.config.disallowedContent))
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, g = [], k = this.editor && this.editor.config.protectedSource, f, h = !1,
                    m = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (f = t(e, a, g, m), f & 1) h = !0; else if (f & 2) return !1
                ...
                for (; l = a.pop();) if (c = l.el, c.parent) switch (p = F[c.parent.name] || F.span, l.check) {
                    ...
                    case "el-up":
                        c.parent.type ==
                        CKEDITOR.NODE_DOCUMENT_FRAGMENT || p[c.name] || u(c, d, a);
                        break;
                    case "parent-down":
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var g = void 0, k = void 0, f = void 0, h = void 0, u = void 0, m = void 0;
                        c = [];
                        for (k = 0; k < b.length; ++k) f = b[k], "string" == typeof f ? (f = f.split(/\s*:\s*/), h = f[0], u = null, m = f[1]) : (h = f.check, u = f.left, m = f.right), g || (g = f, g = g.element ? g.element : h ? h.match(/^([a-z0-9]+)/i)[0] :
                            g.left.getDefinition().element), u instanceof CKEDITOR.style && (u = B(u)), c.push({
                            check: h == g ? null : h,
                            left: u,
                ...
                if ("string" == typeof a) {
                    ...
                    e = d
                } else d = a.getDefinition(), e = d.styles, h = d.attributes || {}, e && !CKEDITOR.tools.isEmpty(e) ? (e = G(e), h.style = CKEDITOR.tools.writeCssText(e, !0)) : e = {}, e = {
                    name: d.element,
                    attributes: h,
                ...
                var h = CKEDITOR.tools.clone(e), u = [], m;
                if (!1 !== b && (m = this._.transformations[e.name])) {
                    for (d =
                             0; d < m.length; ++d) y(this, e, m[d]);
                    p(e)
                }
                t(this, h, u, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
        ...
        var K = {styles: 1, attributes: 1, classes: 1},
            ...
            S = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, O = /^cke:(object|embed|param)$/,
            T = /^(object|embed|param)$/, M;
        M = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, e = c.attributes, g, f, k, h;
                    a.name = c.element;
                    for (g in e) if ("class" ==
                        g) for (c = a.classes.join("|"), k = e[g].split(/\s+/); h = k.pop();) -1 == c.indexOf(h) && a.classes.push(h); else a.attributes[g] = e[g];
        ...
        var a, f = function (b) {
            ...
            var e = b.getKeystroke(),
                f = this.keystrokes[e], l = this._.editor;
            a = !1 === l.fire("key", {keyCode: e, domEvent: b});
            a || (f && (a = !1 !== l.execCommand(f, {from: "keystrokeHandler"})), a || (a = !!this.blockedKeystrokes[e]));
        ...
        CKEDITOR.lang = {
            languages: {
                ...
                var c = f.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), e = c[1], c = c[2];
                    ...
                    var n = function (a, b) {
                        ...
                        if (a[b]) n(b, !0); else {
                            ...
                            if (!(1 < d.length)) {
                                ...
                                c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ?
        ...
        add: function (a, f) {
            ...
            CKEDITOR.fire(a +
                CKEDITOR.tools.capitalize(this.fileName) + "Ready", b);
            return this.get(a)
        }, get: function (a) {
            ...
            for (var c = this.loaded, e = this.registered, m = [], l = {}, d = {}, h = 0; h < a.length; h++) {
                var k = a[h];
                if (k) if (c[k] || e[k]) d[k] = this.get(k); else {
            ...
            CKEDITOR.scriptLoader.load(m, function (a, e) {
                ...
                for (var g = 0; g < a.length; g++) for (var k = l[a[g]],
                                                            h = 0; h < k.length; h++) {
                    var m = k[h];
                    d[m] = this.get(m);
                    c[m] = 1
        ...
        return function (b, c, e) {
            var m = {}, l = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], d;
                    for (d in a) {
                        var n = a[d], v = n && n.requires;
                        if (!f[d]) {
                            if (n.icons) for (var t = n.icons.split(","), w = t.length; w--;) CKEDITOR.skin.addIcon(t[w], n.path + "icons/" + (CKEDITOR.env.hidpi &&
                            n.hidpi ? "hidpi/" : "") + t[w] + ".png");
                            f[d] = 1
                        }
        ...
        function a(a, e, g) {
            ...
            CKEDITOR.fire("instanceCreated", null,
                this);
            CKEDITOR.add(this);
        ...
        function e(a, b) {
            b[b.startDisabled ? "disable" : a.readOnly &&
            !b.readOnly ? "disable" : b.modes[a.mode] ? "enable" : "disable"]()
        }
        ...
        function d(a,
            ...
            a.on("customConfigLoaded", function () {
                ...
                a.blockless = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ?
                    !(a.element.is("textarea") || CKEDITOR.dtd[a.element.getName()].p) : !1;
            ...
            b && null != b.customConfig && (a.config.customConfig =
                b.customConfig);
        ...
        function n(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var k in c) {
                    var h = c[k], u = h.lang, m = null, l = h.requires, r;
                    CKEDITOR.tools.isArray(l) && (l = l.join(","));
                    if (l && (r = l.match(f))) for (; l = r.pop();) CKEDITOR.error("editor-plugin-required", {
                        plugin: l.replace(",", ""),
                        requiredBy: k
                    });
                    u && !a.lang[k] && (u.split && (u = u.split(",")), 0 <= CKEDITOR.tools.indexOf(u, a.langCode) ? m = a.langCode : (m = a.langCode.replace(/-.*/, ""), m = m != a.langCode && 0 <= CKEDITOR.tools.indexOf(u, m) ? m : 0 <= CKEDITOR.tools.indexOf(u, "en") ? "en" : u[0]), h.langEntries && h.langEntries[m] ? (a.lang[k] =
                        h.langEntries[m], m = null) : g.push(CKEDITOR.getUrl(h.path + "lang/" + m + ".js")));
                    e.push(m);
                    d.push(h)
                }
                CKEDITOR.scriptLoader.load(g, function () {
                    ...
                    for (f = 0; f < a.config.blockedKeystrokes.length; f++) a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[f]] =
                        1;
                    a.status = "loaded";
                    a.fireOnce("loaded");
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                var b = this._.data;
                "string" != typeof b && (b = (b = this.element) && this.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE ?
                    b.is("textarea") ? b.getValue() : b.getHtml() : "");
                b = {dataValue: b};
                ...
                if (e ||
                    !c) this.once("dataReady", function (a) {
                    !c && d && this.fire("saveSnapshot");
                    e && e.call(a.editor)
                });
                a = {dataValue: a};
                ...
                for (var d = new CKEDITOR.dom.documentFragment, e, g, f, k = 0; k < c.length; k++) {
                ...
                for (var a =
                    this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, d, e = b.length; e--;) c = b[e], d = 0, CKEDITOR.tools.isArray(c) && (d = c[1], c = c[0]), d ? a[c] = d : delete a[c]
        ...
        CKEDITOR.htmlParser.prototype = {
            onTagOpen: function () {
                ...
                for (var c, e, m = 0, l; c = this._.htmlPartsRegex.exec(b);) {
                    e = c.index;
                    if (e > m) if (m = b.substring(m, e), l) l.push(m); else this.onText(m);
                    m = this._.htmlPartsRegex.lastIndex;
                    if (e = c[1]) if (e = e.toLowerCase(), l && CKEDITOR.dtd.$cdata[e] && (this.onCDATA(l.join("")),
                        l = null), !l) {
                        this.onTagClose(e);
                        continue
                    }
        ...
        CKEDITOR.htmlParser.node.prototype = {
            ...
            insertAfter: function (a) {
                var f = a.parent.children, b = CKEDITOR.tools.indexOf(f, a), c = a.next;
                f.splice(b + 1, 0, this);
                this.next = a.next;
                this.previous = a;
                a.next = this;
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (m, l, d) {
            function h(a) {
                ...
                if (0 < q.length) for (var c = 0; c < q.length; c++) {
                    var d =
                        q[c], e = d.name, g = CKEDITOR.dtd[e], f = z.name && CKEDITOR.dtd[z.name];
            ...
            function n(b, c, e) {
                ...
                var f = z;
                void 0 === b.previous &&
                (v(c, b) && (z = c, w.onTagOpen(d, {}), b.returnPoint = c = z), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (u = !1), "textarea" == b.name && (A = !1));
            ...
            var w = new CKEDITOR.htmlParser,
                ...
                q = [], r = [], z = p, A = "textarea" == p.name, u = "pre" == p.name;
            ...
            w.onTagClose = function (a) {
                ...
                for (var c = [], e = [], g = z; g != p && g.name != a;) g._.isBlockLike || e.unshift(g), c.push(g), g = g.returnPoint || g.parent;
                if (g != p) {
            ...
            w.onText =
                function (a) {
                    ...
                    if (!A && !g["#"] && b in f) w.onTagOpen(e[b] || ""), w.onText(a); else {
                        k();
                        h();
                        u || A || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a);
                        if (v(z, a)) this.onTagOpen(d, {}, 0, 1);
                        z.add(a)
                    }
                };
        ...
        function f(b, c, e, f) {
            var l, d;
            for (l in c) (d = b[l]) || (d = b[l] = new a), d.add(c[l], e, f)
        }
            ...
            CKEDITOR.tools.createClass({
                $: function (b) {
                    ...
                    addRules: function (a, c) {
                        ...
                        var e = c.type;
                        return e == CKEDITOR.NODE_ELEMENT ? this.onElement(a, c) : e == CKEDITOR.NODE_TEXT ? new CKEDITOR.htmlParser.text(this.onText(a,
                            c.value)) : e == CKEDITOR.NODE_COMMENT ? new CKEDITOR.htmlParser.comment(this.onComment(a, c.value)) : null
        ...
        a.prototype = {
            add: function (a, c, e) {
                ...
                for (var c =
                    this.rules, e = c.length - 1; 0 <= e && a < c[e].priority;) e--;
                return e + 1
            }, exec: function (a, c) {
                var e = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    f = Array.prototype.slice.call(arguments, 1), l = this.rules, d = l.length, h, k, g, n;
                ...
                return c
                                     ...
                                     c) {
                for (var e = 0, f = this.rules, l = f.length, d; c && e < l; e++) d = f[e], a.nonEditable && !d.options.applyToAll || a.nestedEditable && d.options.excludeNestedEditable || (c = c.replace(d.value[0], d.value[1]));
                return c
            }
        }
    }(),function () {
        function a(a, d) {
            ...
            function f(a, d) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var f = [], h = b(e), u, l;
                        if (h) for (k(h, 1) && f.push(h); h;) m(h) &&
                        (u = c(h)) && k(u) && ((l = c(u)) && !m(l) ? f.push(u) : (g(y).insertAfter(u), u.remove())), h = h.previous;
            ...
            function k(a, b) {
                if ((!y || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT &&
            ...
            var h = {elements: {}}, y = "html" == d, n = CKEDITOR.tools.extend({}, u), E;
                    ...
                    return function (b) {
                        if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                            ...
                            if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"]; else {
                                ...
                                var f = c(b);
                                !d && m(b.parent) ? l(b.parent, g(a)) : m(d) && f && !m(f) && g(a).insertBefore(d)
                            }
                        }
                    }
                }(y);
        ...
        function g(a, b) {
            return a.replace(b, function (a, b, c) {
                0 === a.indexOf("\x3ctextarea") && (a = b + t(c).replace(/</g, "\x26lt;").replace(/>/g,
        ...
        function p(a, b) {
            var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore = {id: 1}),
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            d.addRules(x);
            d.addRules(B, {applyToAll: !0});
            d.addRules(a(b, "html"), {applyToAll: !0});
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, d, c = p(c, b), c = g(c, H), c = k(c), c = g(c, I), c = c.replace(J, "$1cke:$2"),
            ...
            b.on("toDataFormat", function (a) {
                ...
                a.data.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(c,
                    a.data.context, f(a.data.enterMode, b.config.autoParagraph))
            }, null, null, 5);
            b.on("toDataFormat", function (a) {
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                ...
                return this.editor.fire("toDataFormat", {
                    dataValue: a,
                    filter: d || this.editor.filter, context: c, enterMode: e || this.editor.enterMode
                }).dataValue
            }
        };
        var q = /(?:&nbsp;|\xa0)$/, r = "{cke_protected}", z = CKEDITOR.dtd,
            A = "caption colgroup col thead tfoot tbody".split(" "),
            u = CKEDITOR.tools.extend({}, z.$blockLimit, z.$block), y = {elements: {input: d, textarea: d}},
        ...
        var D = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            E = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, S = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
        ...
        var f = {};
        ((a instanceof CKEDITOR.htmlParser.element ? a.attributes.style :
            a) || "").replace(/&quot;/g, '"').replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, c, e) {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                for (; ;) {
                    l = f.name;
                    if (!(d =
                        a.onElementName(b, l))) return this.remove(), !1;
                    f.name = d;
                ...
                var h, k;
                for (h in l) {
                    for (d = l[h]; ;) if (k = a.onAttributeName(b, h)) if (k != h) delete l[h], h = k; else break; else {
                        delete l[h];
                        break
                    }
                    k && (!1 === (d = a.onAttribute(b, f, k, d)) ? delete l[k] : l[k] = d)
                }
                f.isEmpty || this.filterChildren(a, !1,
                    b);
                return !0
            }, filterChildren: b.filterChildren, writeHtml: function (a, b) {
                b && this.filter(b);
                var m = this.name, l = [], d = this.attributes, h, k;
                a.openTag(m, d);
                for (h in d) l.push([h, d[h]]);
                a.sortAttributes && l.sort(f);
                h = 0;
                for (k = l.length; h < k; h++) d = l[h], a.attribute(d[0], d[1]);
        ...
        function a(a, e, m, l) {
            ...
            l == CKEDITOR.ELEMENT_MODE_REPLACE && (a.setStyle("visibility", "hidden"), d._.required =
        ...
        function b(a) {
            var b = a.name, f = a.element, l = a.elementMode, d = a.fire("uiSpace", {space: "top", html: ""}).html,
                h = a.fire("uiSpace", {space: "bottom", html: ""}).html,
                k = new CKEDITOR.template('\x3c{outerEl} id\x3d"cke_{name}" class\x3d"{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir\x3d"{langDir}" lang\x3d"{langCode}" role\x3d"application"' + (a.title ? ' aria-labelledby\x3d"cke_{name}_arialbl"' :
                ...
                b = CKEDITOR.dom.element.createFromHtml(k.output({
                    ...
                    langCode: a.langCode,
                    voiceLabel: a.title,
                    topHtml: d ? '\x3cspan id\x3d"' +
                        a.ui.spaceId("top") + '" class\x3d"cke_top cke_reset_all" role\x3d"presentation" style\x3d"height:auto"\x3e' + d + "\x3c/span\x3e" : "",
        ...
        CKEDITOR.replaceAll = function () {
            for (var a =
                ...
                if (l.name || l.id) {
                    ...
                    } else if ("function" == typeof arguments[0] && (f = {}, !1 === arguments[0](l, f))) continue;
                    this.replace(l, f)
                }
            }
        };
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            var f = this, l = this._.modes;
            if (a != f.mode && l && l[a]) {
                f.fire("beforeSetMode",
                    a);
                if (f.mode) {
                    var d = f.checkDirty(), l = f._.previousModeData, h, k = 0;
                    f.fire("beforeModeUnload");
                    f.editable(0);
                    f._.previousMode = f.mode;
                    f._.previousModeData = h = f.getData(1);
                    "source" == f.mode && l == h && (f.fire("lockSnapshot", {forceUpdate: !0}), k = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, f, l) {
            var d = this.container, h = this.ui.space("contents"),
            ...
            l.setSize("width", a, !0);
            k && (k.style.width = "1%");
            var g = (l.$.offsetHeight || 0) - (h.$.clientHeight || 0), d = Math.max(b - (f ? 0 : g), 0);
            b = f ? b + g : b;
            h.setStyle("height", d + "px");
            k && (k.style.width = "100%");
            this.fire("resize", {
                outerHeight: b,
                contentsHeight: d, outerWidth: a || l.getSize("width")
            })
        };
        ...
        function a(a) {
            var b = a.editor, d = a.data.path, e = d.blockLimit, g = a.data.selection, k = g.getRanges()[0], h;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (g = f(g, d)) g.appendBogus(), h = CKEDITOR.env.ie;
            ...
            }, !e.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) && (b = k.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(),
                h = 1, a.cancel());
            h && k.select()
        }
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                on: function (a, b) {
                    ...
                    var f, k;
                    if (g) for (; (f = b.getCommonAncestor(0,
                        1)) && (k = CKEDITOR.dtd[f.getName()]) && (!k || !k[e]);) f.getName() in CKEDITOR.dtd.span ? b.splitElement(f) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(f), b.collapse(!0), f.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                    ...
                    function a() {
                        ...
                        a:if (d.anchorNode && d.anchorNode == c.$) e = !0; else {
                            if (CKEDITOR.env.webkit && (e =
                                c.getDocument().getActive()) && e.equals(c) && !d.anchorNode) {
                                e = !0;
                                break a
                            }
                            e = void 0
                    ...
                    function b() {
                        ...
                        "None" == d.type && e.equals(c) && (d = new CKEDITOR.dom.range(c), a = a.body.createTextRange(), d.moveToElementEditStart(c), d = d.startContainer, d.type != CKEDITOR.NODE_ELEMENT && (d = d.getParent()),
                            a.moveToElementText(d.$), a.collapse(!0), a.select())
                    }
                    ...
                    if (b) {
                        ...
                        if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) {
                            a:{
                                var d = c.block.getElementsByTag("span"), g = 0,
                                    f;
                    ...
                    this.attachListener(a, "beforeGetData", function () {
                        var b = this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(w, function (a, b) {
                            return b
                        }));
                        a.setData(b, null, 1)
                    }, this);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (h) {
                            var f = e.getHead(), l = f.getCustomData("stylesheet");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in n) {
                                b = a.getSelection();
                                var e, f = b.getRanges()[0], k = f.startPath(), h, l, r, c = 8 == c;
                                CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (e = b.getSelectedElement()) || (e = m(b)) ? (a.fire("saveSnapshot"), f.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e.remove(), f.select(), a.fire("saveSnapshot"),
                                    ...
                                    f["moveToElementEdit" + (c ? "End" : "Start")](r), f.checkStartOfBlock() && f.checkEndOfBlock() ? r.remove() : f.select(), a.fire("saveSnapshot"), d = 1) : (l = k.contains(["td", "th", "caption"])) && f.checkBoundaryOfElement(l, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
                            }
                            return !d
                        });
        ...
        p = function () {
            ...
            function b(c, d) {
                var e, g, f, k, h = [], l = d.range.startContainer;
                e = d.range.startPath();
                for (var l = m[l.getName()], n = 0, r = c.getChildren(), q = r.count(), p = -1, w = -1, C = 0, t = e.contains(m.$list); n < q; ++n) e = r.getItem(n), a(e) ? (f = e.getName(), t && f in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (k = !!l[f], "br" != f || !e.data("cke-eol") || n && n != q - 1 || (C = (g = n ? h[n - 1].node : r.getItem(n + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && m.$block[g.getName()]), -1 != p || k || (p = n), k || (w = n), h.push({
                    isElement: 1,
                    isLineBreak: C,
                ...
                -1 < p && (h[p].firstNotAllowed = 1);
                -1 < w && (h[w].lastNotAllowed = 1);
                return h
            }

            function e(b, c) {
                var d = [], g = b.getChildren(), f = g.count(), k, h = 0, l = m[c], n = !b.is(m.$inline) || b.is("br");
            ...
            var m = CKEDITOR.dtd, n = {
                ...
                dl: 1,
                blockquote: 1
            }, r = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, q = CKEDITOR.tools.extend({}, m.$inline);
            delete q.br;
            return function (n, E, p, w) {
                ...
                if (!w.checkReadOnly()) {
                    ...
                    n = {
                        type: E, dontFilter: z, editable: n, editor: t, range: w, blockLimit: v,
                        mergeCandidates: [], zombies: []
                    };
                    E = n.range;
                    w = n.mergeCandidates;
                    var A, I;
                    ...
                    if (!E.collapsed) {
                        var t = v.block || v.blockLimit, ga = E.getCommonAncestor();
                    ...
                    A = E.startPath();
                    if (t = A.contains(f, !1, 1)) E.splitElement(t), n.inlineStylesRoot = t, n.inlineStylesPeak = A.lastElement;
                    A = E.createBookmark();
                    (t = A.startNode.getPrevious(c)) && a(t) && f(t) && w.push(t);
                    (t = A.startNode.getNext(c)) && a(t) && f(t) && w.push(t);
                    ...
                    if (A = p) {
                        ...
                        if ("text" ==
                            ...
                            for (w = n.inlineStylesRoot.getParent(); !I.equals(w);) E = E.appendTo(I.clone()), I = I.getParent();
                    ...
                    if (A) {
                        ...
                        var U, Z;
                        E = P.startContainer;
                        var z = n.endPath.elements[0], aa, v = z.getPosition(E),
                        ...
                        for (h(E, P); w < E.length; w++) {
                            ...
                            if (L) p = 0 < w; else {
                                L = P.startPath();
                                !v.isBlock && l(n.editor, L.block, L.blockLimit) && (Y = d(n.editor)) && (Y = A.createElement(Y), Y.appendBogus(), P.insertNode(Y), CKEDITOR.env.needsBrFiller && (R = Y.getBogus()) && R.remove(), P.moveToPosition(Y, CKEDITOR.POSITION_BEFORE_END));
                                ...
                                if (t && v.isElement) {
                                    ...
                                    if (L) U && (Z = P.splitElement(U), n.zombies.push(Z), n.zombies.push(U)); else {
                                        U = I.getName();
                                        aa = !w;
                                        L = w == E.length - 1;
                                        U = e(v.node, U);
                                ...
                                v.lastNotAllowed && w < E.length - 1 && ((Z = ga ?
                                    z : Z) && P.setEndAt(Z, CKEDITOR.POSITION_AFTER_START), t = 0);
                                P.collapse()
                            }
                        }
        ...
        z = {
            eol: {
                ...
                rebuild: function (a, b) {
                    var c = a.range, d = c.getCommonAncestor(),
                        e = new CKEDITOR.dom.elementPath(d, b), g = new CKEDITOR.dom.elementPath(c.startContainer, b),
                        c = new CKEDITOR.dom.elementPath(c.endContainer, b), f;
            ...
            return {
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), g = d.endPath(),
                            f = e.contains(CKEDITOR.dtd.$list), k = g.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            var d = a.mergeListBookmark.startNode, e = a.mergeListBookmark.endNode,
                                g = new CKEDITOR.dom.elementPath(d, c), f = new CKEDITOR.dom.elementPath(e, c);
                            if (a.mergeList) {
                        ...
                        if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
                            var d = a.mergeBlockBookmark.startNode, e = a.mergeBlockBookmark.endNode,
                                g = new CKEDITOR.dom.elementPath(d,
                                    c), f = new CKEDITOR.dom.elementPath(e, c), g = g.block, f = f.block;
                    ...
                    function a(c) {
                        var e = [], g, f = new CKEDITOR.dom.walker(c), k = c.startPath().contains(d),
                            h = c.endPath().contains(d), l = {};
                        f.guard = function (a, f) {
                            ...
                            if (f && k && a.equals(k)) g = c.clone(), g.setEndAt(k, CKEDITOR.POSITION_BEFORE_END), e.push(g); else if (!f && h &&
                                a.equals(h)) g = c.clone(), g.setStartAt(h, CKEDITOR.POSITION_AFTER_START), e.push(g); else {
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var f = c(g, e.bookmark), k = f.clone(),
            ...
            if (c) {
                if (!1 !== b) {
                    var e = a.getDocument().getSelection().getNative(),
                        g = e && "None" != e.type && e.getRangeAt(0), f = t.length;
                    if (c.getLength() > f && g && g.intersectsNode(c.$)) {
                        var k = [{node: e.anchorNode, offset: e.anchorOffset}, {
                            node: e.focusNode,
        ...
        var n = "function" != typeof window.getSelection, v = 1, t = CKEDITOR.tools.repeat("​", 7),
            w = new RegExp(t + "( )?", "g"), p, q, r = CKEDITOR.dom.walker.invisible(1),
            z = function () {
                function a(b) {
                    return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            d.on("contentDom", function () {
                ...
                var e = d.document, g = CKEDITOR.document, h = d.editable(), m = e.getBody(),
                    r = e.getDocumentElement(), u = h.isInline(), q, E;
                ...
                h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
                    q && CKEDITOR.env.webkit && (q = d._.previousActive && d._.previousActive.equals(e.getActive())) && null !=
                ...
                if (CKEDITOR.env.ie || u) n ? h.attachListener(h, "beforedeactivate", b, null, null, -1) : h.attachListener(d, "selectionCheck", b, null, null, -1), h.attachListener(h, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
                    d.lockSelection(E);
                    q = 1
                ...
                if (CKEDITOR.env.ie && !u) {
                    ...
                    if ("BackCompat" != e.$.compatMode) {
                        ...
                        if (7 <
                            CKEDITOR.env.version && 11 > CKEDITOR.env.version) r.on("mousedown", function (a) {
            ...
            getNative: function () {
                ...
                var a = n ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, g, f, h = b.duplicate(), k = 0,
                                 l = e.length - 1, m = -1, n, r; k <= l;) if (m = Math.floor((k + l) / 2), g = e[m], h.moveToElementText(g), n = h.compareEndPoints("StartToStart", b), 0 < n) l = m - 1; else if (0 > n) k = m + 1; else return {
                            container: d,
                            offset: a(g)
                        };
                        if (-1 == m || m == e.length - 1 && 0 > n) {
                            ...
                            for (d = e.length; 0 < h && 0 < d;) f = e[--d], f.nodeType ==
                            CKEDITOR.NODE_TEXT && (r = f, h -= f.nodeValue.length);
                            return {container: r, offset: -h}
                        }
                        h.collapse(0 < n ? !0 : !1);
                        h.setEndPoint(0 < n ? "StartToStart" : "EndToStart", b);
                        h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!h) return {container: d, offset: a(g) + (0 < n ? 0 : 1)};
                        for (; 0 < h;) try {
                            f = g[0 < n ? "previousSibling" : "nextSibling"], f.nodeType == CKEDITOR.NODE_TEXT && (h -= f.nodeValue.length, r = f), g = f
                        } catch (q) {
                            return {container: d, offset: a(g)}
                        }
                        return {container: r, offset: 0 < n ? -h : r.nodeValue.length + h}
                    };
                    return function () {
                        ...
                        if (d == CKEDITOR.SELECTION_ELEMENT) {
                            for (var d = [], e = 0; e < c.length; e++) {
                                for (var g = c.item(e), f = g.parentNode, h = 0, a = new CKEDITOR.dom.range(this.root); h <
                                f.childNodes.length && f.childNodes[h] != g; h++) ;
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    if (f) this.fake(f); else {
                        if (n) {
                            ...
                            g ? (h = f.document.$.body.createTextRange(), h.moveToElementText(g.$), p.setEndPoint("EndToEnd", h), p.moveEnd("character", -1)) : (r = b.getNext(k), q = b.hasAscendant("pre"), r = !(r && r.getText && r.getText().match(h)) && (q || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")),
                                q = f.document.createElement("span"), q.setHtml("\x26#65279;"), q.insertBefore(b), r && f.document.createText("﻿").insertBefore(b));
                            f.setStartBefore(b);
                            b.remove();
                            ...
                            for (p = 0; p < a.length; p++) {
                                if (p < a.length - 1 && (r = a[p], q = a[p + 1], h = r.clone(), h.setStart(r.endContainer,
                                    r.endOffset), h.setEnd(q.startContainer, q.startOffset), !h.collapsed && (h.shrink(CKEDITOR.NODE_ELEMENT, !0), f = h.getCommonAncestor(), h = h.getEnclosedNode(), f.isReadOnly() || h && h.isReadOnly()))) {
                                ...
                                f.collapsed && CKEDITOR.env.webkit && e(f) && (h = m(this.root), f.insertNode(h), (r = h.getNext()) && !h.getPrevious() && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() ? (l(this.root), f.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START)) :
                                    f.moveToPosition(h, CKEDITOR.POSITION_AFTER_END));
                                q.setStart(f.startContainer.$, f.startOffset);
                                try {
                                    q.setEnd(f.endContainer.$, f.endOffset)
                                } catch (E) {
                                    if (0 <= E.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) f.collapse(1), q.setEnd(f.endContainer.$, f.endOffset); else throw E;
                                }
                                g.addRange(q)
                            }
                        }
        ...
        function b(c) {
            var d = c.document;
            if (c.collapsed) d = r(this, d), c.insertNode(d), c.moveToPosition(d, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                var q = c.createBookmark(),
                    p = q.startNode, t = q.endNode, z = p, u;
                if (!l) {
                    var v = c.getCommonAncestor(), l = a(p, v), v = a(t, v);
                    l && (z = l.getNextSourceNode(!0));
                    v && (t = v)
                }
                for (z.getPosition(t) == CKEDITOR.POSITION_FOLLOWING && (z = 0); z;) {
                    l = !1;
                    if (z.equals(t)) z = null, l = !0; else {
                        ...
                        if (v && m && CKEDITOR.dtd.$block[A]) for (var C = z, x = e(C), B = void 0, D = x.length, ea = 0,
                                                                       C = D && new CKEDITOR.dom.range(C.getDocument()); ea < D; ++ea) {
                        ...
                        if (x) if (B = z.getParent(), x = h, D = g, ea = k, !B || !(B.getDtd() || CKEDITOR.dtd.span)[D] && !ea || x.parentRule && !x.parentRule(B)) l = !0; else {
                            if (u || A && CKEDITOR.dtd.$removeEmpty[A] && (z.getPosition(t) | K) != K || (u = c.clone(), u.setStartBefore(z)), A = z.type, A == CKEDITOR.NODE_TEXT || v || A == CKEDITOR.NODE_ELEMENT && !z.getChildCount()) {
                                for (var A =
                                    z, H; (l = !A.getNext(I)) && (H = A.getParent(), n[H.getName()]) && f(H, p, h, J);) A = H;
                                u.setEndAfter(A)
                            }
                        } else l = !0;
                    ...
                    if (l && u && !u.collapsed) {
                        for (var l = r(this, d), v = l.hasAttributes(), y = u.getCommonAncestor(), A = {}, x = {}, B = {}, D = {}, fa, W, F; l && y;) {
                            if (y.getName() == g) {
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                (e.getName() == this.element ? t.call(this, e) : p(e, u(this)[e.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), e = g
            }
            a.moveToBookmark(c);
        ...
        function d(a) {
            ...
            (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = r(this, e, d), k(d, g));
            a.moveToBookmark(b)
        }
        ...
        function t(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, e = u(this)[a.getName()],
                g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), f;
            for (f in d) if ("class" != f && !this._.definition.fullMatch ||
        ...
        function w(a) {
            for (var b = u(this), c = a.getElementsByTag(this.element),
                     d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || t.call(this, d, !0);
            for (var g in b) if (g != this.element) for (c = a.getElementsByTag(g), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e), d.isReadOnly() || p(d, b[g])
        }
        ...
        var B = {
                ...
                audio: 1,
                video: 1
            }, F = /\s*(?:;\s*|$)/, G = /#\((.+?)\)/g, I = CKEDITOR.dom.walker.bookmark(0, 1),
            ...
            apply: function (a) {
                ...
                switch (this.type) {
                    ...
                    case CKEDITOR.STYLE_INLINE:
                        for (var c =
                            a.elements, d = 0, e; d < c.length; d++) if (e = c[d], this.type != CKEDITOR.STYLE_INLINE || e != a.block && e != a.blockLimit) {
        ...
        compare: function (a) {
            ...
            var e = this.elements, m = e.length;
            f && m--;
        ...
        function a(a, c, e) {
            var f = a.serializable, l = c[e ? "endContainer" : "startContainer"], d = e ? "endOffset" : "startOffset",
        ...
        var f = {
            createIterator: function () {
                var a = this, c = CKEDITOR.dom.walker.bookmark(), e = [], f;
                return {
        ...
        function f(b) {
            var c =
                CKEDITOR.skin["ua_" + b], d = CKEDITOR.env;
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            getUiColor: function () {
                ...
                return (this.setUiColor = function (a) {
                    this.uiColor = a;
                    var c = CKEDITOR.skin.chameleon, f = "", k = "";
        ...
        var l = "cke_ui_color", d = [], h = /\$color/g;
        ...
        if (a = CKEDITOR._.pending) for (delete CKEDITOR._.pending, f = 0; f < a.length; f++) CKEDITOR.editor.prototype.constructor.apply(a[f][0],
                    ...
                    labeledElement: function (b, c, d, e) {
                        ...
                        if (!(3 > arguments.length)) {
                            ...
                            var f = this._.inputId = CKEDITOR.tools.getNextId() + "_textInput",
                                l = {"class": "cke_dialog_ui_input_" + c.type, id: f, type: c.type};
                        ...
                        if (!(3 > arguments.length)) {
                            a.call(this, c);
                            var f = this, l = this._.inputId = CKEDITOR.tools.getNextId() + "_textarea", m = {};
                            c.validate && (this.validate = c.validate);
                            m.rows = c.rows || 5;
                            m.cols = c.cols || 20;
                        ...
                        if (!(3 > arguments.length)) {
                            ...
                            CKEDITOR.ui.dialog.uiElement.call(this, b, c, d, "span", null, null, function () {
                                var a = CKEDITOR.tools.extend({}, c, {id: c.id ? c.id + "_checkbox" : CKEDITOR.tools.getNextId() + "_checkbox"}, !0),
                                    d = [], f = CKEDITOR.tools.getNextId() + "_label", g = {
                            ...
                            CKEDITOR.ui.dialog.labeledElement.call(this,
                                b, c, d, function () {
                                    for (var a = [], d = [], g = (c.id ? c.id : CKEDITOR.tools.getNextId()) + "_radio", m = 0; m < c.items.length; m++) {
                                        var r = c.items[m], z = void 0 !== r[2] ? r[2] : r[0],
                                            A = void 0 !== r[1] ? r[1] : r[0],
                                            u = CKEDITOR.tools.getNextId() + "_radio_input", y = u + "_label",
                                            u = CKEDITOR.tools.extend({}, c, {id: u, title: null, type: null}, !0),
                                            z = CKEDITOR.tools.extend({}, u, {title: z}, !0), C = {
                                                type: "radio",
                        ...
                        if (!(3 > arguments.length)) {
                            ...
                            CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                                ...
                                l(a);
                                for (var m = 0, r; m < c.items.length && (r = c.items[m]); m++) f.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== r[1] ? r[1] : r[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(r[0]));
                                "undefined" != typeof a.inputStyle && (a.style = a.inputStyle);
                ...
                CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, c, {
                    getInputElement: function () {
                        ...
                        var b = this._, c = CKEDITOR.document.getById(b.frameId).getFrameDocument(), d = b.definition,
                            e = b.buttons, f = this.formLoadedNumber, l = this.formUnloadNumber,
                            m = b.dialog._.editor.lang.dir, q = b.dialog._.editor.langCode;
        ...
        function k(a) {
            function b(c) {
                var k = a.getSize(), l = CKEDITOR.document.getWindow().getViewPaneSize(), m = c.data.$.screenX,
                    r = c.data.$.screenY, n = m - d.x, q = r - d.y;
                d = {x: m, y: r};
                e.x += n;
                e.y += q;
        ...
        function g(a) {
            function b(c) {
                var r = "rtl" == f.lang.dir, n = m.width, q = m.height,
                    p = n + (c.data.$.screenX - l.x) * (r ? -1 : 1) * (a._.moved ? 1 : 2),
                    z = q + (c.data.$.screenY - l.y) * (a._.moved ? 1 : 2), u = a._.element.getFirst(),
                    u = r && u.getComputedStyle("right"), w = a.getPosition();
                w.y + z > k.height && (z = k.height - w.y);
                (r ? u : w.x) + p > k.width && (p = k.width - (r ? u : w.x));
                if (e == CKEDITOR.DIALOG_RESIZE_WIDTH || e == CKEDITOR.DIALOG_RESIZE_BOTH) n = Math.max(d.minWidth ||
                    0, p - g);
            ...
            if (e != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f = a.getParentEditor(),
                    g, h, k, l, m, r, n = CKEDITOR.tools.addFunction(function (d) {
                        m = a.getSize();
                ...
                a.on("load", function () {
                    ...
                    b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + f.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(f.lang.common.resize) +
                        '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event )"\x3e' + ("ltr" == f.lang.dir ? "◢" : "◣") + "\x3c/div\x3e");
        ...
        function v(a) {
            var b = CKEDITOR.document.getWindow(), c = a.config, d = CKEDITOR.skinName || a.config.skin,
                e = c.dialog_backgroundCoverColor || ("moono-lisa" == d ? "black" : "white"),
                d = c.dialog_backgroundCoverOpacity, f = c.baseFloatZIndex, c = CKEDITOR.tools.genKey(e, d, f),
                g = C[c];
            g ? g.show() :
        ...
        var w = CKEDITOR.tools.cssLength,
            p = '\x3cdiv class\x3d"cke_reset_all {editorId} {editorDialogClass} {hidpi}" dir\x3d"{langDir}" lang\x3d"{langCode}" role\x3d"dialog" aria-labelledby\x3d"cke_dialog_title_{id}"\x3e\x3ctable class\x3d"cke_dialog ' +
        ...
        CKEDITOR.dialog = function (b, d) {
            ...
            function r(c) {
                if (x == CKEDITOR.dialog._.currentTop) {
                    var d = c.data.getKeystroke(), e = "rtl" == b.lang.dir, g = [37, 38, 39, 40];
                    v = y = 0;
                    if (9 == d || d == CKEDITOR.SHIFT + 9) l(d == CKEDITOR.SHIFT + 9 ? -1 : 1), v = 1; else if (d == CKEDITOR.ALT + 121 && !x._.tabBarMode && 1 < x.getPageCount()) x._.tabBarMode = !0, x._.tabs[x._.currentTabId][0].focus(), x._.currentFocusIndex = -1, v = 1; else if (-1 != CKEDITOR.tools.indexOf(g,
                        ...
                        this._.tabBarMode = !1, this._.currentFocusIndex = -1, l(1), v = 1;
                    n(c)
                }
            }
            ...
            var p = CKEDITOR.dialog._.dialogDefinitions[d], z = CKEDITOR.tools.clone(q),
                w = b.config.dialog_buttonsOrder || "OS", A = b.lang.dir, t = {}, v, y;
            ("OS" == w && CKEDITOR.env.mac || "rtl" == w && "ltr" == A || "ltr" == w && "rtl" == A) && z.buttons.reverse();
            ...
            this.definition = p = CKEDITOR.fire("dialogDefinition",
                {name: d, definition: p}, b).definition;
            ...
            this.on("show", function () {
                ...
                b.config.dialog_startupFocusTab && a ? (x._.tabBarMode = !0, x._.tabs[x._.currentTabId][0].focus(), x._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = a ? -1 : this._.focusList.length - 1, p.onFocus ?
        ...
        CKEDITOR.dialog.prototype = {
            destroy: function () {
                ...
                for (var c in b.contents) if (b.contents[c]) {
                    var a = b.contents[c], e = this._.tabs[a.id], f = a.requiredContent, g = 0;
                    if (e) {
        ...
        var q = {
            ...
            for (var d = 0, e; e = a[d]; d++) if (e.id == b || c && e[c] && (e = r(e[c],
                b, c))) return e;
            return null
        ...
        var y, C = {}, x, B = {}, D = function (a) {
            ...
            (b = B[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + e]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key),
                a.data.preventDefault()))
                ...
                uiElement: function (a, b, c, d, e, f, g) {
                    if (!(4 > arguments.length)) {
                        var h = (d.call ? d(b) : d) || "div",
                            k = ["\x3c", h, " "], l = (e && e.call ? e(b) : e) || {},
                            m = (f && f.call ? f(b) : f) || {}, r = (g && g.call ? g.call(this, a, b) : g) || "",
                    ...
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var f = this._.children = b, g = e && e.widths || null, h = e && e.height || null, k,
                            l = {role: "presentation"};
                        e && e.align && (l.align = e.align);
                        CKEDITOR.ui.dialog.uiElement.call(this, a, e || {type: "hbox"}, d, "table", {}, l, function () {
                ...
                functions: function () {
                    ...
                    return function () {
                        var b = this && this.getValue ? this.getValue() :
                            a[0], c, d = CKEDITOR.VALIDATE_AND, e = [], f;
        ...
        init: function (a) {
            var f = 0, b = function (b, d, e, k) {
                if (k) {
                    ...
                    a.addCommand(e, new CKEDITOR.styleCommand(k, {contentForms: g}));
                    a.ui.addButton && a.ui.addButton(b, {label: d, command: e, toolbar: "basicstyles," + (f += 10)})
                }
            }, c = {
            ...
            }, e = a.config, m = a.lang.basicstyles;
            ...
            a.setKeystroke([[CKEDITOR.CTRL + 66, "bold"], [CKEDITOR.CTRL + 73, "italic"],
        ...
        var a = {
            exec: function (a) {
                var b = a.getCommand("blockquote").state, c = a.getSelection(), e = c && c.getRanges()[0];
                if (e) {
                    var m = c.createBookmarks();
                    if (CKEDITOR.env.ie) {
                        var l = m[0].startNode, d = m[0].endNode, h;
        ...
        function f(b) {
            ...
            function m(a, c) {
                ...
                if (!d.getById("cke_pastebin")) {
                    var k = b.getSelection(), l = k.createBookmarks();
                    ...
                    r.setAttributes({id: "cke_pastebin", "data-cke-temp": "1"});
                    var n = 0, d = d.getWindow();
                    CKEDITOR.env.webkit ? (e.append(r),
                        r.addClass("cke_editable"), e.is("body") || (n = "static" != e.getComputedStyle("position") ? e : CKEDITOR.dom.element.get(e.$.offsetParent), n = n.getDocumentPosition().y)) : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(r);
                    r.setStyles({
                        position: "absolute",
                    ...
                    CKEDITOR.env.safari && r.setStyles(CKEDITOR.tools.cssVendorPrefix("user-select", "text"));
                    (n = r.getParent().isReadOnly()) ?
                        (r.setOpacity(0), r.setAttribute("contenteditable", !0)) : r.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-10000px");
            ...
            function y(c) {
                var d = {type: "auto", method: "paste", dataTransfer: B.initPasteDataTransfer(c)};
            ...
            function x(a) {
                if (G && a in {paste: 1, cut: 1}) return CKEDITOR.TRISTATE_DISABLED;
            ...
            var B = CKEDITOR.plugins.clipboard, D = 0, F = 0, G = 0;
            (function () {
                b.on("key", u);
                b.on("contentDom", c);
            ...
            (function () {
                function a(c, d, e, f, h) {
                    ...
                    b.ui.addButton && b.ui.addButton(c, {
                        label: k, command: d, toolbar: "clipboard," +
                        f
                    });
            ...
            b.getClipboardData = function (a, c) {
                ...
                !1 === A() && (b.removeListener("paste", d), h && b.fire("pasteDialog", f) ? (b.on("pasteDialogCommit", e), b.on("dialogHide", function (a) {
                    a.removeListener();
        ...
        function h(b) {
            ...
            b.on("contentDom", function () {
                ...
                var k = b.editable(), l = CKEDITOR.plugins.clipboard.getDropTarget(b), m = b.ui.space("top"),
                    A = b.ui.space("bottom");
                ...
                k.attachListener(b, "drop", function (a) {
                    if (a = a.data) {
                        var f = a.dropRange, h = a.dragRange, k = a.dataTransfer;
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "dialog", init: function (a) {
                ...
                if (CKEDITOR.env.gecko) {
                    var l = ["image/png", "image/jpeg", "image/gif"], w;
                ...
                a.on("paste", function (b) {
                    ...
                    if (!b.data.dataValue) {
                        ...
                        if (d) b.data.dataValue = d, b.data.type = "html"; else if (d = c.getData("text/plain")) b.data.dataValue =
                ...
                a.on("paste", function (d) {
                    d = d.data;
                    var e = d.type, f = d.dataValue, h, l = a.config.clipboard_defaultContentType || "html",
                        n = d.dataTransfer.getTransferType(a);
                    h = "html" == e || "html" == d.preSniffing ? "html" : b(f);
                    "htmlifiedtext" == h && (f = c(a.config, f));
                    "text" == e && "html" == h ? f = m(a, f, k.get("plain-text")) :
                        n == CKEDITOR.DATA_TRANSFER_EXTERNAL && a.pasteFilter && !d.dontFilter && (f = m(a, f, a.pasteFilter));
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            canClipboardApiBeTrusted: function (a, b) {
                return a.getTransferType(b) != CKEDITOR.DATA_TRANSFER_EXTERNAL || CKEDITOR.env.chrome && !a.isEmpty() || CKEDITOR.env.gecko &&
                (a.getData("text/html") || a.getFilesCount()) ? !0 : !1
            },
            ...
            fixSplitNodesAfterDrop: function (a, b, c, d) {
                function e(a, c, d) {
                    ...
                    if (f.equals(c) && d != c.getChildCount()) return a = b.startContainer.getChild(b.startOffset - 1), c = b.startContainer.getChild(b.startOffset), a && a.type == CKEDITOR.NODE_TEXT && c && c.type == CKEDITOR.NODE_TEXT && (d = a.getLength(), a.setText(a.getText() +
                        c.getText()), c.remove(), b.setStart(a, d), b.collapse(!0)), !0
                }
            ...
            internalDrop: function (b,
                                    c, d, e) {
                var f = CKEDITOR.plugins.clipboard, h = e.editable(), k, l;
                e.fire("saveSnapshot");
                ...
                c = k.endNode;
                l = f.startNode;
                c && b.getPosition(l) & CKEDITOR.POSITION_PRECEDING && c.getPosition(l) & CKEDITOR.POSITION_FOLLOWING &&
                l.insertBefore(b);
                b = e.createRange();
                b.moveToBookmark(k);
            ...
            getRangeAtDropPosition: function (a, b) {
                var c = a.data.$, d = c.clientX, e = c.clientY, f = b.getSelection(!0).getRanges()[0],
                    h = b.createRange();
                if (a.data.testRange) return a.data.testRange;
                if (document.caretRangeFromPoint) c = b.document.$.caretRangeFromPoint(d, e), h.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset),
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (k) {
                                ...
                                var x = b.document.$.elementFromPoint(d, e), B = new CKEDITOR.dom.element(x), D;
            ...
            initPasteDataTransfer: function (a, b) {
                if (this.isCustomCopyCutSupported) {
                    if (a && a.data && a.data.$) {
                        ...
                        this.copyCutData && c.id == this.copyCutData.id ? (c = this.copyCutData, c.$ = a.data.$.clipboardData) :
                            this.copyCutData = c;
                        return c
                    }
        ...
        var a = CKEDITOR.addTemplate("panel", '\x3cdiv lang\x3d"{langCode}" id\x3d"{id}" dir\x3d{dir} class\x3d"cke cke_reset_all {editorId} cke_panel cke_panel {cls} cke_{dir}" style\x3d"z-index:{z-index}" role\x3d"presentation"\x3e{frame}\x3c/div\x3e'),
            ...
            b = CKEDITOR.addTemplate("panel-frame-inner",
        ...
        CKEDITOR.ui.panel.prototype = {
            render: function (c, e) {
                    ...
                    if (!a) {
                        if (this.isFramed) {
                            ...
                            a.on("keydown", function (a) {
                                ...
                                this._.onKeyDown && !1 === this._.onKeyDown(b) ? a.data.preventDefault() :
                ...
                if (this.isFramed) {
                    var l = CKEDITOR.env.air ? "javascript:void(0)" : CKEDITOR.env.ie ? "javascript:void(function(){" +
                        encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.close();") + "}())" : "";
                    m.frame = f.output({id: this.id + "_frame", src: l})
                }
                l = a.output(m);
                e && e.push(l);
                return l
                ...
                a = this._.blocks[a];
                var b = this._.currentBlock, f = !this.forceIFrame ||
                CKEDITOR.env.ie ? this._.holder : this.document.getById(this.id + "_frame");
                b && b.hide();
        ...
        CKEDITOR.ui.panel.block = CKEDITOR.tools.createClass({
            $: function (a, b) {
                ...
                show: function () {
                    ...
                    switch (f) {
                        case "next":
                            for (var l = this._.focusIndex, f = this.element.getElementsByTag("a"), d; d = f.getItem(++l);) if (d.getAttribute("_cke_focus") && d.$.offsetWidth) {
                                this._.focusIndex = l;
                                d.focus();
                                break
                            }
        ...
        function a(a, c, e, m, l) {
            ...
            var d = f[l];
            d || (d = f[l] = new CKEDITOR.ui.panel(c,
                m), d.element = e.append(CKEDITOR.dom.element.createFromHtml(d.render(a), c)), d.element.setStyles({
                display: "none",
                position: "absolute"
            }));
            return d
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (b, c, e, f) {
                ...
                var d = c.getDocument();
                f = a(b, d, c, e, f || 0);
                var h = f.element, k = h.getFirst(), g = this;
                ...
                addBlock: function (a, c) {
                    ...
                    var n = this.element, g = this._.iframe,
                        ...
                        w = c.getDocumentPosition(v), v = t ? t.getDocumentPosition(v) : {x: 0, y: 0},
                        p = "rtl" == this._.dir, q = w.x + (f || 0) - v.x, r = w.y + (l || 0) - v.y;
                    !p || 1 != e && 4 != e ? p || 2 != e && 3 != e || (q += c.$.offsetWidth -
                        1) : q += c.$.offsetWidth;
                    if (3 == e || 4 == e) r += c.$.offsetHeight - 1;
                    this._.panel._.offsetParentId = c.getId();
                    n.setStyles({top: r + "px", left: 0, display: ""});
                    n.setOpacity(0);
                    ...
                    this._.blurSet || (CKEDITOR.event.useCapture = !0, g.on("blur", function (a) {
                        ...
                        this.allowBlur() && a.data.getPhase() == CKEDITOR.EVENT_PHASE_AT_TARGET && this.visible && !this._.activeChild && (CKEDITOR.env.iOS ? this._.hideTimeout || (this._.hideTimeout =
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            var b = h.element.getWindow(), a = n.$.getBoundingClientRect(), b = b.getViewPaneSize(),
                                ...
                                f = p ? a.right : b.width - a.left, g = p ? b.width - a.right : a.left;
                            ...
                            CKEDITOR.env.ie && (b = a = new CKEDITOR.dom.element(n.$.offsetParent), "html" == b.getName() &&
                            (b = b.getDocument().getBody()), "rtl" == b.getComputedStyle("direction") && (q = CKEDITOR.env.ie8Compat ? q - 2 * n.getDocument().getDocumentElement().$.scrollLeft : q - (a.$.scrollWidth - a.$.clientWidth)));
                            var a = n.getFirst(), l;
                            (l = a.getCustomData("activePanel")) && l.onHide && l.onHide.call(this, 1);
                            a.setCustomData("activePanel", this);
                            n.setStyles({top: r + "px", left: q + "px"});
                            n.setOpacity(1);
                            d && d()
                        }, this);
                    ...
                    }, this), this._.activeChild = a, this._.focused = !1, a.showBlock(c, e, f, l, d), this.blur(),
        ...
        requires: "floatpanel", beforeInit: function (a) {
            for (var f = a.config.menu_groups.split(","),
                     b = a._.menuGroups = {}, c = a._.menuItems = {}, e = 0; e < f.length; e++) b[f[e]] = e + 1;
            ...
            $: function (a, b) {
                ...
                onShow: function () {
                    ...
                    for (var f = 0; f < e.length; f++) {
                        var g = e[f](b, a, c);
                        if (g) for (var n in g) {
                            var v = this.editor.getMenuItem(n);
                            !v || v.command && !this.editor.getCommand(v.command).state || (v.state = g[n], this.add(v))
                        }
                    }
                }, onClick: function (a) {
                    this.hide();
                ...
                add: function (a) {
                    ...
                    var f = this.items, g = this.editor, n = this._.panel, v = this._.element;
                    if (!n) {
                    ...
                    for (var t = g.elementPath(), t = ['\x3cdiv class\x3d"cke_menu' + (t && t.direction() != g.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], w = f.length, p = w && f[0].group, q = 0; q < w; q++) {
                        var r = f[q];
                        p != r.group && (t.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'),
                            p = r.group);
                        r.render(this, q, t)
                    }
                    t.push("\x3c/div\x3e");
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a, b, c) {
                ...
                render: function (a, f, d) {
                    var h = a.id + String(f), k = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state,
                        g = "", n = this.editor, v, t,
                    ...
                    var p = this.getItems, q = "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";",
                        r = this.name;
                    ...
                    a = {
                        ...
                        shortcutHtml: t ? e.output({shortcut: t.display}) : "",
                        arrowHtml: p ? c.output({label: q}) : "",
        ...
        function a(a, b) {
            ...
            g.onClick = l;
            var v = CKEDITOR.tools.addFunction(l), t = CKEDITOR.tools.addFunction(function (b, c) {
                var d = g.idBase, f;
            ...
            a.on("selectionChange", function () {
                for (var b = [], d = g.list = [], f = [], l = g.filters, m = !0, A = a.elementPath().elements, u, y = A.length; y--;) {
                    var C = A[y], x = 0;
                    u = C.data("cke-display-name") ? C.data("cke-display-name") : C.data("cke-real-element-type") ? C.data("cke-real-element-type") : C.getName();
                ...
                d = d.length;
                for (l = 0; l < d; l++) u = f[l], m = a.lang.elementspath.eleTitle.replace(/%1/, u), u = c.output({
                    id: n + l,
                    label: m,
                    text: u,
        ...
        CKEDITOR.plugins.add("indent", {
            init: function (b) {
                ...
                b.on("dirChanged", function (a) {
                    var e = b.createRange(), d = a.data.node;
                    e.setStartBefore(d);
                    e.setEndAfter(d);
                    for (var f = new CKEDITOR.dom.walker(e), k; k = f.next();) if (k.type == CKEDITOR.NODE_ELEMENT) if (!k.equals(d) && k.getDirection()) e.setStartAfter(k), f = new CKEDITOR.dom.walker(e); else {
            ...
            genericDefinition: function (a) {
                ...
                a.on("pluginsLoaded", function () {
                    for (var a in b) (function (a, b) {
                        var c = a.getCommand(b.relatedGlobal), e;
        ...
        function a(a) {
            function c(f) {
                for (var h = t.startContainer, m = t.endContainer; h && !h.getParent().equals(f);) h = h.getParent();
                for (; m && !m.getParent().equals(f);) m =
                    m.getParent();
                if (!h || !m) return !1;
                for (var p = h, h = [], w = !1; !w;) p.equals(m) && (w = !0), h.push(p), p = p.getNext();
                ...
                for (var p = e.isIndent ? 1 : -1, m = h[0], h = h[h.length - 1], w = CKEDITOR.plugins.list.listToArray(f, g), y = w[h.getCustomData("listarray_index")].indent, m = m.getCustomData("listarray_index"); m <= h.getCustomData("listarray_index"); m++) if (w[m].indent += p, 0 < p) {
                    var v = w[m].parent;
                    w[m].parent = new CKEDITOR.dom.element(v.getName(),
                        v.getDocument())
                }
                ...
                if (B && B.length) for (m = 0; m < B.length; m++) {
                    for (D = f = B[m]; (D = D.getNext()) && D.is && D.getName() in l;) CKEDITOR.env.needsNbspFiller && !f.getFirst(b) &&
                    f.append(t.document.createText(" ")), f.append(D);
                    f.insertAfter(x)
                }
            ...
            for (var e = this, g = this.database, l = this.context, m = a.getSelection(), m = (m && m.getRanges()).createIterator(), t; t = m.getNextRange();) {
                ...
                if (!w) {
                    ...
                    p.getName() in l && (t.setStartAt(p, CKEDITOR.POSITION_AFTER_START), t.setEndAt(p, CKEDITOR.POSITION_BEFORE_END), w = p)
                }
        ...
        var c = CKEDITOR.dom.walker.whitespaces(!0), e = CKEDITOR.dom.walker.bookmark(!1, !0),
        ...
        CKEDITOR.plugins.add("indentlist", {
            requires: "indent", init: function (b) {
                ...
                e.registerCommands(b, {indentlist: new c(b, "indentlist", !0), outdentlist: new c(b, "outdentlist")});
        ...
        function a(a, b, c) {
            ...
            var k = CKEDITOR.plugins.list.arrayToList(e,
                c, null, a.config.enterMode, b.root.getAttribute("dir")).listNode, l, m;
            d(!0);
            d();
            k.replace(b.root);
        ...
        function m(a, d, e) {
            ...
            var h = d.createBookmark(), k = new CKEDITOR.dom.elementPath(d.startContainer), m = k.block,
                k = k.lastElement.getAscendant("li", 1) || m, t = new CKEDITOR.dom.elementPath(e.startContainer),
                v = t.contains(CKEDITOR.dtd.$listItem), t = t.contains(CKEDITOR.dtd.$list);
            m ? (m = m.getBogus()) && m.remove() : t && (m = t.getPrevious(g)) && n(m) && m.remove();
        ...
        var d = {ol: 1, ul: 1}, h = CKEDITOR.dom.walker.whitespaces(),
            k = CKEDITOR.dom.walker.bookmark(), g = function (a) {
                return !(h(a) || k(a))
            ...
            listToArray: function (a, b, c, e, f) {
                ...
                for (var g = 0, h = a.getChildCount(); g < h; g++) {
                    ...
                    if ("li" == k.$.nodeName.toLowerCase()) {
                        var l = {parent: a, indent: e, element: k, contents: []};
                        ...
                        c.push(l);
                        for (var m = 0, n = k.getChildCount(), t; m < n; m++) t = k.getChild(m), t.type == CKEDITOR.NODE_ELEMENT && d[t.getName()] ? CKEDITOR.plugins.list.listToArray(t, b, c, e + 1, l.grandparent) : l.contents.push(t)
                    }
                }
                return c
                ...
                for (var h, l = a[c].parent.getDocument(), m = new CKEDITOR.dom.documentFragment(l),
                         n = null, t = c, v = Math.max(a[c].indent, 0), D = null, F, G, I = e == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                    var H = a[t];
                    h = H.grandparent;
                    ...
                    if (H.indent == v) {
                        ...
                        t++
                    } else if (H.indent == Math.max(v, 0) + 1) H = a[t - 1].element.getDirection(1), t = CKEDITOR.plugins.list.arrayToList(a,
                        null, t, e, H != F ? F : null), !D.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= l.$.documentMode && D.append(l.createText(" ")), D.append(t.listNode), t = t.nextIndex; else if (-1 == H.indent && !c && h) {
                        d[h.getName()] ? (D = H.element.clone(!1, !0), F != h.getDirection(1) && D.setAttribute("dir", F)) : D = new CKEDITOR.dom.documentFragment(l);
                        var n = h.getDirection(1) != F, K = H.element, J = K.getAttribute("class"),
                            E = K.getAttribute("style"),
                            S = D.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (e != CKEDITOR.ENTER_BR || n || E || J), O,
                            T = H.contents.length, M;
                        for (h = 0; h < T; h++) if (O = H.contents[h], k(O) && 1 < T) S ? M = O.clone(1, 1) : D.append(O.clone(1, 1)); else if (O.type == CKEDITOR.NODE_ELEMENT && O.isBlockBoundary()) {
                        ...
                        } else S ? (G || (G = l.createElement(I), D.append(G), n && G.setAttribute("dir", F)), E && G.setAttribute("style", E), J && G.setAttribute("class",
                            J), M && (G.append(M), M = null), G.append(O.clone(1, 1))) : D.append(O.clone(1, 1));
                ...
                return {listNode: m, nextIndex: t}
            }
        };
        var v = /^h[1-6]$/, t = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT);
        f.prototype = {
            exec: function (b) {
                this.refresh(b, b.elementPath());
                var e = b.config, f = b.getSelection(),
                    h = f && f.getRanges();
                ...
                for (var e = f.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0; (l = h.getNextRange()) && ++n;) {
                    var t = l.getBoundaryNodes(), x = t.startNode, B = t.endNode;
                    x.type == CKEDITOR.NODE_ELEMENT &&
                    "td" == x.getName() && l.setStartAt(t.startNode, CKEDITOR.POSITION_AFTER_START);
                    ...
                    for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; t = l.getNextParagraph();) if (!t.getCustomData("list_block")) {
                        ...
                        for (var D = b.elementPath(t), x = D.elements, B = 0, D = D.blockLimit, F, G = x.length - 1; 0 <= G && (F = x[G]); G--) if (d[F.getName()] && D.contains(F)) {
                            D.removeCustomData("list_group_object_" +
                                n);
                            (x = F.getCustomData("list_group_object")) ? x.contents.push(t) : (x = {
                                root: F,
                                contents: [t]
                ...
                for (F = []; 0 < k.length;) if (x = k.shift(), this.state == CKEDITOR.TRISTATE_OFF) if (d[x.root.getName()]) {
                    ...
                    B = CKEDITOR.plugins.list.listToArray(n.root,
                        x);
                    D = [];
                    for (t = 0; t < n.contents.length; t++) G = n.contents[t], (G = G.getAscendant("li", !0)) && !G.getCustomData("list_item_processed") && (D.push(G), CKEDITOR.dom.element.setMarker(x, G, "list_item_processed", !0));
                    for (var G = n.root.getDocument(), I = void 0, H = void 0, t = 0; t < D.length; t++) {
                        var K = D[t].getCustomData("listarray_index"), I = B[K].parent;
                        I.is(this.type) || (H = G.createElement(this.type), I.copyAttributes(H, {
                            start: 1,
                            type: 1
                        }), H.removeStyle("list-style-type"), B[K].parent = H)
                    }
                    x = CKEDITOR.plugins.list.arrayToList(B, x, null,
                        h.config.enterMode);
                    B = void 0;
                    ...
                    if (!(1 > n.length)) {
                        ...
                        t.push(G);
                        for (I = t = void 0; n.length;) t = n.shift(), I = h.createElement("li"), H = t, H.is("pre") || v.test(H.getName()) || "false" == H.getAttribute("contenteditable") ? t.appendTo(I) : (t.copyAttributes(I), x && t.getDirection() && (I.removeStyle("direction"), I.removeAttribute("dir")),
                            t.moveChildren(I), t.remove()), I.appendTo(G);
                ...
                var c = b.contains(d, 1), e = b.blockLimit || b.root;
        ...
        CKEDITOR.plugins.add("list",
            {
                requires: "indentlist", init: function (a) {
                    a.blockless || (a.addCommand("numberedlist", new f("numberedlist", "ol")), a.addCommand("bulletedlist", new f("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton("NumberedList", {
                        ...
                        var c = b.data.domEvent.getKey(), f;
                        if ("wysiwyg" == a.mode &&
                            c in {8: 1, 46: 1}) {
                            var h = a.getSelection().getRanges()[0], k = h && h.startPath();
                            if (h && h.collapsed) {
                                var t = 8 == c, v = a.editable(), C = new CKEDITOR.dom.walker(h.clone());
                                C.evaluator = function (a) {
                                    return g(a) && !n(a)
                                };
                                ...
                                if (t) {
                                    var x;
                                    (x = k.contains(d)) && h.checkBoundaryOfElement(x, CKEDITOR.START) && (x = x.getParent()) && x.is("li") && (x = l(x)) ? (f = x, x = x.getPrevious(g), c.moveToPosition(x && n(x) ? x : f, CKEDITOR.POSITION_BEFORE_START)) : (C.range.setStartAt(v,
                                    ...
                                    if (f) m(a, c, h), b.cancel(); else {
                                        var B = k.contains(d);
                                        B && h.checkBoundaryOfElement(B, CKEDITOR.START) && (f = B.getFirst(g), h.checkBoundaryOfElement(f, CKEDITOR.START) && (x = B.getPrevious(g),
                                ...
                                } else C.range.setEndAt(v, CKEDITOR.POSITION_BEFORE_END), (x = C.next()) && x.type == CKEDITOR.NODE_ELEMENT && x.is(d) && (x = x.getFirst(g), k.block && h.checkStartOfBlock() && h.checkEndOfBlock() ? (k.block.remove(), h.moveToElementEditStart(x), h.select()) : l(x) ? (h.moveToElementEditStart(x), h.select()) :
        ...
        var c = CKEDITOR.dom.walker.whitespaces(), e = CKEDITOR.dom.walker.bookmark();
        CKEDITOR.plugins.enterkey = {
            enterBlock: function (a, d, m, v) {
                if (m = m || f(a)) {
                    m = b(m);
                    var t = m.document, w = m.checkStartOfBlock(), p = m.checkEndOfBlock(),
                        q = a.elementPath(m.startContainer), r = q.block, z = d == CKEDITOR.ENTER_DIV ? "div" : "p", A;
                    if (w && p) {
                        if (r && (r.is("li") || r.getParent().is("li"))) {
                            ...
                            A = m.getParent();
                            v = !r.hasPrevious();
                            var u = !r.hasNext(), z = a.getSelection(), y = z.createBookmarks(), w = r.getDirection(1),
                                p = r.getAttribute("class"), C = r.getAttribute("style"), x = A.getDirection(1) != w;
                            a = a.enterMode != CKEDITOR.ENTER_BR || x || C || p;
                            if (A.is("li")) v || u ? (v && u && m.remove(), r[u ? "insertAfter" : "insertBefore"](A)) : r.breakParent(A); else {
                                if (a) if (q.block.is("li") ? (A = t.createElement(d == CKEDITOR.ENTER_P ? "p" : "div"), x && A.setAttribute("dir", w), C && A.setAttribute("style", C), p && A.setAttribute("class", p), r.moveChildren(A)) : A = q.block, v || u) A[v ? "insertBefore" : "insertAfter"](m); else r.breakParent(m), A.insertAfter(m); else if (r.appendBogus(!0),
                                v || u) for (; t = r[v ? "getFirst" : "getLast"]();) t[v ? "insertBefore" : "insertAfter"](m); else for (r.breakParent(m); t = r.getLast();) t.insertAfter(m);
                                r.remove()
                            }
                            z.selectBookmarks(y);
                            return
                    ...
                    if (w =
                        ...
                        } else r.is("li") && (A = m.clone(), A.selectNodeContents(r), A = new CKEDITOR.dom.walker(A),
                            A.evaluator = function (a) {
                                return !(e(a) || c(a) || a.type == CKEDITOR.NODE_ELEMENT && a.getName() in CKEDITOR.dtd.$inline && !(a.getName() in CKEDITOR.dtd.$empty))
                            }, (y = A.next()) && y.type == CKEDITOR.NODE_ELEMENT && y.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? t.createElement("br") : t.createText(" ")).insertBefore(y)), r && m.moveToElementEditStart(r);
                        m.select();
                        m.scrollIntoView()
                    }
                }
                ...
                if (c = c || f(a)) {
                    ...
                    e || "li" != r ? (!e && m && h.test(r) ? (m = q.getDirection()) ? (l = l.createElement("div"), l.setAttribute("dir", m), l.insertAfter(q), c.setStart(l, 0)) : (l.createElement("br").insertAfter(q), CKEDITOR.env.gecko && l.createText("").insertAfter(q), c.setStartAt(q.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (a = "pre" == r && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? l.createText("\r") : l.createElement("br"), c.deleteContents(), c.insertNode(a), CKEDITOR.env.needsBrFiller ?
                        (l.createText("﻿").insertAfter(a), m && (q || p.blockLimit).appendBogus(), a.getNext().$.nodeValue = "", c.setStartAt(a.getNext(), CKEDITOR.POSITION_AFTER_START)) : c.setStartAt(a, CKEDITOR.POSITION_AFTER_END)), c.collapse(!0), c.select(), c.scrollIntoView()) : d(a, b, c, e)
                }
            }
        };
        var m = CKEDITOR.plugins.enterkey, l = m.enterBr, d = m.enterBlock, h = /^h[1-6]$/
    }(),function () {
        function a(a, b) {
            var c = {}, e = [], m = {nbsp: " ", shy: "­", gt: "\x3e", lt: "\x3c", amp: "\x26", apos: "'", quot: '"'};
            ...
            if (!b && a) {
                a = a.split(",");
                var l = document.createElement("div"), d;
        ...
        CKEDITOR.plugins.add("entities", {
            afterInit: function (f) {
                ...
                if (f =
                    ...
                    var l = a(m.join(",")), d = l.regex ? "[" + l.regex + "]" : "a^";
                    delete l.regex;
                    e.entities && e.entities_processNumerical && (d = "[^ -~]|" + d);
                    var d = new RegExp(d, "g"), h = a("nbsp,gt,lt,amp,shy", !0), k = new RegExp(h.regex, "g");
                    f.addRules({
                        text: function (a) {
        ...
        popup: function (a, f, b, c) {
            ...
            640 > f && (f = 640);
            420 > b && (b = 420);
            var e = parseInt((window.screen.height - b) / 2, 10), m = parseInt((window.screen.width -
                f) / 2, 10);
        ...
        function a(a) {
            var e = a.config, m = a.fire("uiSpace", {space: "top", html: ""}).html, l = function () {
                function d(a, c, e) {
                    h.setStyle(c, b(e));
                ...
                var k, m, p, q, r, z, A, u = e.floatSpaceDockedOffsetX || 0, y = e.floatSpaceDockedOffsetY || 0,
                    C = e.floatSpacePinnedOffsetX || 0, x = e.floatSpacePinnedOffsetY || 0;
                return function (d) {
                    if (m = a.editable()) {
                        ...
                        k ? (z + y <= q.top ? g("top") : z + y > r.height - q.bottom ? g("pin") : g("bottom"), d = r.width / 2, d = e.floatSpacePreferRight ? "right" : 0 < q.left && q.right < r.width && q.width > p.width ? "rtl" == e.contentsLangDirection ? "right" : "left" : d - q.left > q.right - d ? "left" : "right", p.width > r.width ? (d = "left", n = 0) : (n = "left" == d ? 0 < q.left ? q.left : 0 : q.right < r.width ? r.width - q.right : 0, n + p.width > r.width && (d = "left" == d ?
                            "right" : "left", n = 0)), h.setStyle(d, b(("pin" == k ? C : u) + n + ("pin" == k ? 0 : "left" == d ? A : -A)))) : (k = "pin", g("pin"), l(d))
                    }
                }
            }();
            if (m) {
        ...
        var f = CKEDITOR.document.getWindow(), b = CKEDITOR.tools.cssLength;
        ...
        CKEDITOR.ui.button.prototype = {
            render: function (a, e) {
                ...
                var l = CKEDITOR.env, d = this._.id = CKEDITOR.tools.getNextId(), h = "", k = this.command, g, n, v;
                this._.editor = a;
                var t = {
                        id: d, button: this, editor: a, focus: function () {
            ...
            CKEDITOR.tools.createClass({
                $: function (a) {
                    ...
                    renderHtml: function (a) {
                        ...
                        var m = CKEDITOR.env, l = "cke_" + this.id, d = CKEDITOR.tools.addFunction(function (c) {
                        ...
                        if (!this._.panel) {
                            var c = this._.panelDefinition,
                                e = this._.panelDefinition.block, f = c.parent || CKEDITOR.document.getBody(),
                                l = "cke_combopanel__" + this.name, d = new CKEDITOR.ui.floatPanel(a, f, c),
                                h = d.addListBlock(this.id, e), k = this;
                            d.onShow = function () {
        ...
        requires: "richcombo", init: function (a) {
            if (!a.blockless) {
                for (var f = a.config, b = a.lang.format, c = f.format_tags.split(";"), e = {}, m = 0, l = [], d = 0; d < c.length; d++) {
                    var h = c[d], k = new CKEDITOR.style(f["format_" + h]);
        ...
        base: CKEDITOR.htmlParser.basicWriter, $: function () {
            ...
            this._.inPre = 0;
            this._.rules = {};
            var a = CKEDITOR.dtd, f;
            for (f in CKEDITOR.tools.extend({}, a.$nonBodyContent, a.$block, a.$listItem, a.$tableContent)) this.setRules(f, {
                indent: !a[f]["#"], breakBeforeOpen: 1, breakBeforeClose: !a[f]["#"],
                breakAfterClose: 1, needsSpace: f in a.$block && !(f in {li: 1, dt: 1, dd: 1})
            });
        ...
        var f = CKEDITOR.htmlParser.cssStyle,
            b = CKEDITOR.tools.cssLength, c = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i, e = {
                elements: {
                    $: function (b) {
                        var c = b.attributes;
        ...
        CKEDITOR.plugins.add("fakeobjects", {
            init: function (a) {
                ...
                (a = (a = a.dataProcessor) && a.htmlFilter) && a.addRules(e, {applyToAll: !0})
            }
        });
        ...
        CKEDITOR.plugins.add("link", {
            requires: "dialog,fakeobjects", onLoad: function () {
                ...
                a.contextMenu && a.contextMenu.addListener(function (b) {
                    ...
                    var c = {};
                    b.getAttribute("href") &&
                    b.getChildCount() && (c = {link: CKEDITOR.TRISTATE_OFF, unlink: CKEDITOR.TRISTATE_OFF});
        ...
        var e = /^javascript:/, m = /^mailto:([^?]+)(?:\?(.+))?$/, l = /subject=([^;?:@&=$,\/]*)/i,
            d = /body=([^;?:@&=$,\/]*)/i, h = /^#(.*)$/, k = /^((?:http|https|ftp|news):\/\/)?(.*)$/,
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (a) {
                ...
                var c = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
                    f = a.plugins.link.compiledProtectionFunction, u = a.config.emailProtection, y, C = {};
                c.match(e) && ("encode" == u ? c = c.replace(n, function (a, b, c) {
                    c = c || "";
                ...
                if (!C.type) if (u = c.match(h)) C.type = "anchor", C.anchor = {}, C.anchor.name = C.anchor.id = u[1]; else if (u = c.match(m)) {
                    y = c.match(l);
                    c = c.match(d);
                    C.type = "email";
                    var x = C.email = {};
                ...
                (C.type = "url", C.url = {}, C.url.protocol = y[1], C.url.url = y[2]);
                if (b) {
                    ...
                    if (B =
                        b.data("cke-saved-name") || c.advName) c.advName = B;
                    CKEDITOR.tools.isEmpty(c) || (C.advanced = c)
                }
                return C
            }, getLinkAttributes: function (c, d) {
                var e = c.config.emailProtection || "", g = {};
                switch (d.type) {
                    case "url":
                ...
                if (d.target) if ("popup" == d.target.type) {
                    for (var e = ["window.open(this.href, '",
                        d.target.name || "", "', '"], n = "resizable status location toolbar menubar fullscreen scrollbars dependent".split(" "), h = n.length, l = function (a) {
                ...
                if (d.advanced) {
                    for (var t in p) (e = d.advanced[p[t]]) &&
                    (g[t] = e);
                    g.name && (g["data-cke-saved-name"] = g.name)
                }
                g["data-cke-saved-href"] && (g.href = g["data-cke-saved-href"]);
                t = {target: 1, onclick: 1, "data-cke-pa-onclick": 1, "data-cke-saved-name": 1, download: 1};
                d.advanced && CKEDITOR.tools.extend(t, p);
                for (var w in g) delete t[w];
                return {set: g, removed: CKEDITOR.tools.objectKeys(t)}
        ...
        function () {
                ...
                return {
                    canUndo: !0, modes: {wysiwyg: 1}, exec: function () {
                        ...
                        return function (f) {
                            ...
                            if (!p(a, f) && f && !f.equals(a.editable) && !f.contains(a.editable)) {
            ...
            function r(a) {
                var b = a.editable, c = a.mouse, d = a.view, e = a.triggerOffset;
                y(a);
            ...
            function z(a) {
                var c = a.mouse, d = a.view, g = a.triggerOffset, h = b(a);
                if (!h) return null;
                u(a, h);
                var g = Math.min(g, 0 | h.size.outerHeight / 2), k = [], l, p;
                if (m(c.y, h.size.top - 1, h.size.top + g)) p = !1; else if (m(c.y,
                    h.size.bottom - g, h.size.bottom + 1)) p = !0; else return null;
            ...
            function A(a, b, c, d) {
                ...
                return B({border: f, padding: h, margin: g, ignoreScroll: c}, k, !0)
            }

            function u(a, b, c) {
                if (!n(b)) return b.size = null;
                if (!b.size) b.size = {}; else if (b.size.ignoreScroll == c && b.size.date > new Date - L) return null;
                return B(b.size, A(a, b, c), {date: +new Date},
                    !0)
            }
            ...
            function x(a, b, c, d) {
                ...
                h;) {
                    k || (k = b(e, d));
                    l || (l = b(g, d));
                    !k && 0 < p.y - h && (e = c(a, {x: p.x, y: p.y - h}));
                    !l && p.y + h < m && (g = c(a, {x: p.x, y: p.y + h}));
                    if (k && l) break;
                    h += 2
                }
            ...
            CKEDITOR.plugins.add("magicline", {
                init: function (a) {
                    ...
                    a.on("contentDom", function () {
                        var l = a.editable(), n = a.document, v = a.window;
                        B(m, {editable: l, inInlineMode: l.isInline(), doc: n, win: v, hotNode: null}, !0);
                        m.boundary = m.inInlineMode ? m.editable : m.doc.getDocumentElement();
                        l.is(H.$inline) || (m.inInlineMode && !t(l) && l.setStyles({
                            position: "relative",
                            top: null,
                            left: null
                        }), d.call(this, m), C(m), l.attachListener(a, "beforeUndoImage", function () {
                            m.line.detach()
                        }),
                            ...
                            if ("wysiwyg" == a.mode && !a.readOnly && !u) {
                                ...
                                u = setTimeout(function () {
                                    ...
                                    u = m.trigger = null;
                                    C(m);
                                    w && !m.hiddenMode && a.focusManager.hasFocus && !m.line.mouseNear() && (m.element =
                                        U(m, !0)) && ((m.trigger = r(m) || z(m) || X(m)) && !p(m, m.trigger.upper || m.trigger.lower) ? m.line.attach().place() : (m.trigger = null, m.line.detach()), w = !1)
                                }, 30)
                            }
                        ...
                        }), l.attachListener(I ? n : v, "mousedown", function () {
                            "wysiwyg" == a.mode && (m.line.detach(), m.hiddenMode = 1, m.mouseDown = 1)
                        }), l.attachListener(I ? n : v, "mouseup", function () {
                            m.hiddenMode =
                                0;
                            m.mouseDown = 0
            ...
            var B = CKEDITOR.tools.extend, D = CKEDITOR.dom.element, F = D.createFromHtml, G = CKEDITOR.env,
                I = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, H = CKEDITOR.dtd, K = {}, J = 128, E = 64, S = 32,
                O = 16, T = 4, M = 2, V = 1, da = " ", ca = H.$listItem, ga = H.$tableContent,
                N = B({}, H.$nonEditable, H.$empty), P = H.$block, L = 100,
            ...
            var U = function () {
                ...
                }(), Z = CKEDITOR.dom.walker.whitespaces(), aa = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT),
                X = function () {
                    function b(e) {
                        ...
                        for (var f = Number.MAX_VALUE, l, p, r, t; h && !h.equals(g) && (p = g.getNext(e.isRelevant));) l = Math.abs(c(e, g, p) - e.mouse.y), l < f && (f = l, r = g, t = p), g = p, u(e, g);
        ...
        CKEDITOR.plugins.add("maximize", {
            init: function (a) {
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    var d = a.lang, h = CKEDITOR.document, k = h.getWindow(), g, n, v, t = CKEDITOR.TRISTATE_OFF;
                    a.addCommand("maximize", {
                        ...
                        exec: function () {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                ...
                                w.setCustomData("maximize_saved_styles",
                                    b(w, !0));
                                p = {overflow: CKEDITOR.env.webkit ? "" : "hidden", width: 0, height: 0};
                                h.getDocumentElement().setStyles(p);
                                ...
                                w.setStyles({left: -1 * p.x + "px", top: -1 * p.y + "px"});
                                CKEDITOR.env.gecko && e(a)
                            } else if (this.state == CKEDITOR.TRISTATE_ON) {
                                k.removeListener("resize", f);
                                for (var q = [p, w], z = 0; z < q.length; z++) c(q[z], q[z].getCustomData("maximize_saved_styles")), q[z].removeCustomData("maximize_saved_styles");
                            ...
                            this.toggleState();
                            if (q = this.uiItems[0]) p = this.state == CKEDITOR.TRISTATE_OFF ? d.maximize.maximize : d.maximize.minimize, q = CKEDITOR.document.getById(q._.id), q.getChild(1).setHtml(p), q.setAttribute("title", p), q.setAttribute("href", 'javascript:void("' +
                                p + '");');
                    ...
                    a.on("mode", function () {
                        ...
                        b.setState(b.state ==
                        CKEDITOR.TRISTATE_DISABLED ? CKEDITOR.TRISTATE_DISABLED : t)
                    }, null, null, 100)
                }
            }
        })
        ...
        CKEDITOR.plugins.add("pastefromword", {
            requires: "clipboard", init: function (b) {
                ...
                b.on("paste",
                    function (f) {
                        var l = f.data, d = l.dataValue,
                            h = /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument|<o:\w+>|<\/font>)/,
                            k = {dataValue: d};
                        if (d && (c || h.test(d)) && (!1 !== b.fire("pasteFromWord", k) || c)) {
                            l.dontFilter = !0;
                            var g = a(b, e, function () {
                                if (g) b.fire("paste", l); else if (!b.config.pasteFromWordPromptCleanup || c || confirm(b.lang.pastefromword.confirmCleanup)) k.dataValue = CKEDITOR.cleanWord(k.dataValue, b), b.fire("afterPasteFromWord", k), l.dataValue = k.dataValue;
                                c = 0
                            });
                            g && f.cancel()
                        }
        ...
        var a =
            {
                canUndo: !1, async: !0, exec: function (f) {
                    f.getClipboardData({title: f.lang.pastetext.title}, function (b) {
                        ...
                        f.fire("afterCommandExec", {name: "pastetext", command: a, returnValue: !!b})
                    })
                }
            };
        CKEDITOR.plugins.add("pastetext", {
            requires: "clipboard", init: function (f) {
                ...
                f.ui.addButton && f.ui.addButton("PasteText", {
                    label: f.lang.pastetext.button, command: "pastetext",
                    ...
                    exec: function (a) {
                        for (var f = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), c = CKEDITOR.plugins.removeformat.filter, e = a.getSelection().getRanges(), m = e.createIterator(), l = function (a) {
                            ...
                            var h = d.createBookmark(),
                                k = h.startNode, g = h.endNode, n = function (b) {
        ...
        init: function (a) {
            function f(b) {
                var e = h.width, f = h.height, l = e + (b.data.$.screenX - d.x) * ("rtl" == m ? -1 : 1);
            ...
            var c = a.config, e = a.ui.spaceId("resizer"), m = a.element ? a.element.getDirection(1) : "ltr";
            ...
            if (!1 !== c.resize_enabled) {
                var l = null, d, h, k = ("both" == c.resize_dir ||
        ...
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", onLoad: function (a) {
            ...
            var f = CKEDITOR.plugins.scayt,
                b = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE, c = function () {
                    f.destroy(a)
                }, e = function () {
            ...
            if ("string" === typeof a.config.scayt_uiTabs && 3 === a.config.scayt_uiTabs.split(",").length) {
                ...
                null === CKEDITOR.tools.search(c, !1) ? a.config.scayt_uiTabs = b : a.config.scayt_uiTabs =
                    [1, 1, 1]
            ...
            if (a.config.scayt_disableOptionsStorage) {
                var f = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ? [a.config.scayt_disableOptionsStorage] : void 0,
                    ...
                    l = CKEDITOR.tools.search, d = CKEDITOR.tools.indexOf;
                a.config.scayt_disableOptionsStorage = function (a) {
                    for (var b = [], c = 0; c < a.length; c++) {
                        var f = a[c], v = !!l(a, "options");
                        if (!l(e, f) || v && l(m, function (a) {
                            if ("lang" === a) return !1
                        })) return;
            ...
            var f = CKEDITOR.plugins.scayt,
                b = a.dataProcessor, c = b && b.htmlFilter, e = a._.elementsPath && a._.elementsPath.filters,
                b = b && b.dataFilter, m = a.addRemoveFormatFilter, l = function (b) {
            ...
            var c = {}, e = {}, m = b ? "word" : "phrase", l = b ? "startGrammarCheck" : "startSpellCheck", d = a.scayt;
            if (0 < f.length && "no_any_suggestions" !== f[0]) if (b) for (b = 0; b < f.length; b++) {
                ...
                b < a.config.scayt_maxSuggestions ? (a.addMenuItem(h, {
                    label: f[b], command: h, group: "scayt_suggest",
                    order: b + 1
            ...
            } else for (b = 0; b < f.length; b++) h = "grayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[b].replace(" ", "_"), a.addCommand(h, this.createCommand(CKEDITOR.plugins.scayt.suggestions[b],
                m, l)), a.addMenuItem(h, {
                label: f[b],
                command: h,
                group: "grayt_suggest",
            ...
            var b = a.scayt, c = this.scaytMenuDefinition(a), e = {}, m = a.config.scayt_contextCommands.split("|"),
            ...
            for (var k in c) d && -1 == CKEDITOR.tools.indexOf(m, k.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (e[k] = "undefined" != typeof c[k].state ? c[k].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof c[k].verification || c[k].verification(a) || delete e[k], a.addCommand(k, {exec: c[k].exec}), a.addMenuItem(k, {
        ...
        charsToObserve: [{
            charName: "cke-fillingChar", charCode: function () {
                var a = CKEDITOR.version.match(/^\d(\.\d*)*/), a = a && a[0], f;
                if (a) {
                    f = "4.5.7";
                    var b, a = a.replace(/\./g, "");
                    f = f.replace(/\./g, "");
        ...
        if ("checkspell" === f) a.on("cancel", function (a) {
                ...
                var c = CKEDITOR.plugins.scayt, e = a.scayt;
                ...
                return function () {
                    ...
                    if (CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state.scayt[this.name] &&
                        ...
                        if (c = "ready" == this.status) var f = e.removeMarkupFromString(this.getSnapshot()),
                            e = e.removeMarkupFromString(this._.previousValue), c = c && e !== f
                    } else c = a.call(this);
                    return c
                }
            });
        ...
        if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
            ...
            a[f] = CKEDITOR.tools.override(a[f], function (a) {
                return function (c) {
                    var e = c.editor.scayt, f = this.contents, l = c.contents, d = null;
            ...
            modes: {wysiwyg: 1}, onLoad: function () {
                ...
                a && a.addRules({
                    elements: {
                        table: function (a) {
                            a = a.attributes;
                            var b = a["class"], f = parseInt(a.border, 10);
        ...
        function () {
            CKEDITOR.plugins.add("stylescombo", {
                requires: "richcombo", init: function (a) {
                    var f = a.config, b = a.lang.stylescombo, c = {}, e = [], m = [];
                    ...
                    a.ui.addRichCombo("Styles", {
                        ...
                        onOpen: function () {
                            var e = a.getSelection().getSelectedElement(), e = a.elementPath(e), d = [0, 0, 0, 0];
                            this.showAll();
                            this.unmarkAll();
                            for (var f in c) {
                                var k = c[f], g = k._.type;
                ...
                editorFocus: !1, canUndo: !1, modes: {wysiwyg: 1}, exec: function (b) {
                    if (b.editable().hasFocus) {
                        ...
                        if (d = (new CKEDITOR.dom.elementPath(c.getCommonAncestor(), c.root)).contains({
                            ...
                            if (f || a) if (f) f = new CKEDITOR.dom.element(f), c.moveToElementEditStart(f), c.checkStartOfBlock() && c.checkEndOfBlock() || c.selectNodeContents(f); else return !0; else {
                                for (var k = d.getAscendant("table").$, f = d.getParent().$.cells, k = new CKEDITOR.dom.element(k.insertRow(-1),
                                    b.document), g = 0, n = f.length; g < n; g++) k.append((new CKEDITOR.dom.element(f[g], b.document)).clone(!1, !1)).appendBogus();
        ...
        var f = {editorFocus: !1, modes: {wysiwyg: 1, source: 1}}, b = {
            exec: function (a) {
        ...
        CKEDITOR.plugins.add("tab", {
            init: function (e) {
                ...
                if (d) e.on("key", function (a) {
                    9 ==
                    a.data.keyCode && (e.insertText(d), a.cancel())
                });
        ...
        var b = void 0 === f ? this.getTabIndex() : f, c, e, m, l, d, h;
        if (0 >=
            b) for (d = this.getNextSourceNode(a, CKEDITOR.NODE_ELEMENT); d;) {
                ...
                a.addCommand("tableDelete",
                    f({
                        exec: function (a) {
                            ...
                            if (b) {
                                var f = b.getParent(), l = a.editable();
        ...
        function a(a) {
            function b(a) {
                0 < c.length || a.type != CKEDITOR.NODE_ELEMENT || !v.test(a.getName()) || a.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(d,
                    a, "selected_cell", !0), c.push(a))
            }
        ...
        function f(b, c) {
            for (var d = a(b), e = d[0], f = e.getAscendant("table"), e = e.getDocument(), g = d[0].getParent(), h = g.$.rowIndex, d = d[d.length - 1], k = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = new CKEDITOR.dom.element(f.$.rows[k]), h = c ? h : k, g = c ? g : d, d = CKEDITOR.tools.buildTableMap(f), f = d[h], h = c ? d[h - 1] : d[h + 1], d = d[0].length, e = e.createElement("tr"), k = 0; f[k] && k < d; k++) {
                var l;
                1 < f[k].rowSpan && h && f[k] == h[k] ? (l = f[k], l.rowSpan += 1) : (l = (new CKEDITOR.dom.element(f[k])).clone(), l.removeAttribute("rowSpan"), l.appendBogus(),
                    e.append(l), l = l.$);
                k += l.colSpan - 1
            }
            ...
            if (c instanceof CKEDITOR.dom.selection) {
                ...
                for (var d = d[d.length - 1], g = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [], h = c; h <= g; h++) {
                    for (var k = f[h], l = new CKEDITOR.dom.element(e.$.rows[h]), m = 0; m < k.length; m++) {
                        var n = new CKEDITOR.dom.element(k[m]), v = n.getParent().$.rowIndex;
                        1 == n.$.rowSpan ? n.remove() : (--n.$.rowSpan, v == h && (v =
                            f[h + 1], v[m - 1] ? n.insertAfter(new CKEDITOR.dom.element(v[m - 1])) : (new CKEDITOR.dom.element(e.$.rows[h + 1])).append(n, 1)));
                        m += n.$.colSpan - 1
                    }
                    d.push(l)
                }
        ...
        function c(a, b) {
            for (var c = b ? Infinity : 0, d = 0; d < a.length; d++) {
                var e;
                e = a[d];
                for (var f = b, g = e.getParent().$.cells, h = 0, k = 0; k <
                g.length; k++) {
        ...
        function e(b, d) {
            ...
            for (l = 0; l < k; l++) f[l] && (1 < f[l].colSpan && e[l] == f[l] ? (g = f[l], g.colSpan += 1) : (g = (new CKEDITOR.dom.element(f[l])).clone(), g.removeAttribute("colSpan"), g.appendBogus(), g[d ? "insertBefore" : "insertAfter"].call(g, new CKEDITOR.dom.element(f[l])),
                g = g.$), l += g.rowSpan - 1)
        }
        ...
        function l(b) {
            if (b instanceof CKEDITOR.dom.selection) {
                b = a(b);
                var c = b[0] && b[0].getAscendant("table"), e;
                a:{
                    var f = 0;
                    e = b.length - 1;
        ...
        function d(a, b) {
            ...
            c["moveToElementEdit" + (b ? "End" :
                "Start")](a) || (c.selectNodeContents(a), c.collapse(b ? !1 : !0));
            c.select(!0)
        }
        ...
        function k(b, c, d) {
            ...
            c = b.getDocument();
            var G = n, D = B = 0, I = !d && new CKEDITOR.dom.documentFragment(c), H = 0;
            for (c = 0; c < e.length; c++) {
                g = e[c];
                var K = g.getParent(), J = g.getFirst(), E = g.$.colSpan, S = g.$.rowSpan, K = K.$.rowIndex,
                    O = h(k, K, g), H = H + E * S, D =
                        Math.max(D, O - v + E);
                B = Math.max(B, K - n + S);
                d || (E = g, (S = E.getBogus()) && S.remove(), E.trim(), g.getChildren().count() && (K == G || !J || J.isBlockBoundary && J.isBlockBoundary({br: 1}) || (G = I.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !G || G.is && G.is("br") || I.append("br")), g.moveChildren(I)), c ? g.remove() : g.setHtml(""));
                G = K
            }
            if (d) return B * D == H;
            I.moveChildren(b);
        ...
        CKEDITOR.plugins.tabletools = {
            requires: "table,dialog,contextmenu", init: function (c) {
                function h(a) {
                    return CKEDITOR.tools.extend(a || {}, {
                        contextSensitive: 1, refresh: function (a, b) {
                            this.setState(b.contains({td: 1, th: 1},
                ...
                p("columnDelete", h({
                    requiredContent: "table", exec: function (b) {
                        b = b.getSelection();
                        b = a(b);
                        var c = b[0], e = b[b.length - 1];
                        b = c.getAscendant("table");
                        for (var f = CKEDITOR.tools.buildTableMap(b), g, h, k = [], l = 0, m = f.length; l < m; l++) for (var n = 0, p = f[l].length; n < p; n++) f[l][n] == c.$ && (g = n), f[l][n] == e.$ && (h = n);
                        for (l = g; l <= h; l++) for (n = 0; n < f.length; n++) e = f[n], c = new CKEDITOR.dom.element(b.$.rows[n]), e = new CKEDITOR.dom.element(e[l]), e.$ && (1 == e.$.colSpan ? e.remove() : --e.$.colSpan, n += e.$.rowSpan - 1, c.$.cells.length || k.push(c));
                ...
                c.addMenuItems && c.addMenuItems({
                    ...
                    tablecell_delete: {label: q.cell.deleteCell, group: "tablecell", command: "cellDelete", order: 15},
                    tablecell_merge: {label: q.cell.merge, group: "tablecell", command: "cellMerge", order: 16},
                    ...
                    tablecell_split_horizontal: {
                        label: q.cell.splitHorizontal, group: "tablecell",
                    ...
                    tablerow: {
                        label: q.row.menu, group: "tablerow", order: 1, getItems: function () {
                            return {
                    ...
                    tablerow_delete: {label: q.row.deleteRow, group: "tablerow", command: "rowDelete", order: 15},
                    tablecolumn: {
                        label: q.column.menu, group: "tablecolumn", order: 1, getItems: function () {
                            return {
        ...
        function a(a) {
            function b() {
                for (var g = c(), h = CKEDITOR.tools.clone(a.config.toolbarGroups) ||
                    f(a), k = 0; k < h.length; k++) {
                    var m = h[k];
                    if ("/" != m) {
                        "string" == typeof m && (m = h[k] = {name: m});
                        var p, q = m.groups;
                        if (q) for (var r = 0; r < q.length; r++) p = q[r], (p = g[p]) && d(m, p);
                        (p = g[m.name]) && d(m, p)
                    }
                }
                return h
            ...
            function d(b,
                ...
                if (c.length) {
                    ...
                    for (var d; d = c.shift();) d = "string" == typeof d ? d : d.name, k && -1 != CKEDITOR.tools.indexOf(k, d) || (d = a.ui.create(d)) && a.addFeature(d) && b.items.push(d)
                }
            }
        ...
        CKEDITOR.plugins.add("toolbar", {
            requires: "button", init: function (e) {
                var f,
                    l = function (a, b) {
                        var c, g = "rtl" == e.lang.dir, n = e.config.toolbarGroupCycling, v = g ? 37 : 39,
                            g = g ? 39 : 37, n = void 0 === n || n;
                        switch (b) {
                            case 9:
                            case CKEDITOR.SHIFT + 9:
                            ...
                            case v:
                                ...
                                return !1;
                            case 40:
                                return a.button && a.button.hasArrow ? (e.once("panelShow", function (a) {
                                    a.data._.panel._.currentBlock.onKeyDown(40)
                                }), a.execute()) : l(a, 40 == b ? v : g), !1;
                            case g:
                            case 38:
                                c = a;
                ...
                e.on("uiSpace", function (c) {
                    if (c.data.space == e.config.toolbarLocation) {
                        ...
                        var f = CKEDITOR.tools.getNextId(),
                            ...
                            f = !1 !== e.config.toolbarStartupExpanded, g, m;
                        ...
                        for (var v = e.toolbox.toolbars, t = a(e), w = t.length, p = 0; p < w; p++) {
                            var q, r = 0, z, A = t[p], u = "/" !== A && ("/" === t[p + 1] || p == w - 1), y;
                            if (A) if (g && (k.push("\x3c/span\x3e"), m = g = 0), "/" === A) k.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e'); else {
                                y = A.items || A;
                                for (var C = 0; C < y.length; C++) {
                                    ...
                                    if (x) {
                                        ...
                                        if (x.type == CKEDITOR.UI_SEPARATOR) m =
                                            g && x; else {
                                            B = !1 !== x.canGroup;
                                            if (!r) {
                                                ...
                                                var F = v.push(r) - 1;
                                                0 < F && (r.previous = v[F - 1], r.previous.next =
                                                    r)
                                            }
        ...
        CKEDITOR.ui.prototype.addToolbarGroup = function (a, b, c) {
            var d = f(this.editor), h = 0 === b, k = {name: a};
            if (c) {
                if (c = CKEDITOR.tools.search(d, function (a) {
                    ...
                    !c.groups && (c.groups = []);
                    if (b &&
                        (b = CKEDITOR.tools.indexOf(c.groups, b), 0 <= b)) {
        ...
        var a = [CKEDITOR.CTRL + 90, CKEDITOR.CTRL + 89, CKEDITOR.CTRL + CKEDITOR.SHIFT + 90], f = {8: 1, 46: 1};
        CKEDITOR.plugins.add("undo", {
            init: function (c) {
                function e(a) {
                    g.enabled &&
                    !1 !== a.data.command.canUndo && g.save()
                }
                ...
                var g = c.undoManager = new b(c), l = g.editingHandler = new m(g), v = c.addCommand("undo", {
                    exec: function () {
        ...
        b.prototype = {
            type: function (a, c) {
                var e = b.getKeyGroup(a), f = this.strokesRecorded[e] + 1;
                ...
                a.bookmarks ? c.selectBookmarks(a.bookmarks) :
                    CKEDITOR.env.ie && (c = this.editor.document.getBody().$.createTextRange(), c.collapse(!0), c.select());
                this.locked = null;
                this.index = a.index;
        ...
        c.prototype = {
            equalsContent: function (a) {
                ...
                a = a.contents;
                CKEDITOR.env.ie &&
                (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks) && (b = b.replace(e, ""), a = a.replace(e, ""));
                return b != a ? !1 : !0
        ...
        m.prototype = {
            onKeydown: function (d) {
                ...
                if (!(b.ieFunctionalKeysBug(a) &&
                    this.lastKeydownImage && this.lastKeydownImage.equalsContent(new c(e.editor, !0)))) if (0 < f) e.type(a); else if (b.isNavigationKey(a)) this.onNavigationKey(!0)
                ...
                var a = this.undoManager.editor, c = a.editable(), e = this;
        ...
        requires: "dialog", parseApi: function (a) {
            ...
            this.parseConfig(a);
            this.parseApi(a);
            a.addCommand("checkspell", new CKEDITOR.dialogCommand("checkspell")).modes = {wysiwyg: !CKEDITOR.env.opera && !CKEDITOR.env.air && document.domain == window.location.hostname && !(f.ie && (8 > f.version || f.quirks))};
        ...
        function a(a) {
            ...
            var c = this.editor, d = a.document, h = d.body, k = d.getElementById("cke_actscrpt");
            ...
            CKEDITOR.env.iOS &&
            this.attachListener(d, "touchend", function () {
                a.focus()
            });
            ...
            $: function () {
                ...
                setData: function (a, c) {
                    ...
                    if (c) this.setHtml(a), this.fixInitialSelection(), f.fire("dataReady"); else {
                        ...
                        f._.dataStore = {id: 1};
                        var d = f.config, h = d.fullPage, k = d.docType,
                    ...
                    a = this.editor;
                    var b = a.config, c = b.fullPage, d = c && a.docType, f = c && a.xmlDeclaration,
                    ...
                    var a = this.editor, b = a.document, f;
                    try {
                        f = a.window.getFrame()
                    } catch (d) {
                    }
        ...
        var a = function (a, b) {
            ...
            a = a.split(",");
            for (var e = 0; e < a.length; e++) CKEDITOR.skin.icons[a[e]] = {path: c, offset: -a[++e], bgsize: a[++e]}
        };
